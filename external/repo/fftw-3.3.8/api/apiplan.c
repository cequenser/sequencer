...
static plan* mkplan0( planner* plnr, unsigned flags, const problem* prb, unsigned hash_info,
...
static plan* mkplan( planner* plnr, unsigned flags, const problem* prb, unsigned hash_info )
{
    plan* pln;
...
apiplan* X( mkapiplan )( int sign, unsigned flags, problem* prb )
{
    ...
    planner* plnr;
    static const unsigned int pats[] = {FFTW_ESTIMATE, FFTW_MEASURE, FFTW_PATIENT, FFTW_EXHAUSTIVE};
    int pat, pat_max;
    double pcost = 0;
