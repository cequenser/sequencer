...
typedef struct
{
    int ( *okp )( const kdft_desc* desc, const R* ri, const R* ii, const R* ro, const R* io, INT is,
...
typedef void ( *kdft )( const R* ri, const R* ii, R* ro, R* io, stride is, stride os, INT vl,
                        INT ivs, INT ovs );
...
typedef struct
{
    int ( *okp )( const struct ct_desc_s* desc, const R* rio, const R* iio, INT rs, INT vs, INT m,
...
typedef void ( *kdftw )( R* rioarray, R* iioarray, const R* W, stride ios, INT mb, INT me, INT ms );
...
typedef void ( *kdftwsq )( R* rioarray, R* iioarray, const R* W, stride is, stride vs, INT mb,
                           INT me, INT ms );
