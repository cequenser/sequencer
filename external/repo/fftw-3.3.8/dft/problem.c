...
static void print( const problem* ego_, printer* p )
{
    ...
    p->print( p, "(dft %d %d %d %D %D %T %T)", ego->ri == ego->ro, X( ialignment_of )( ego->ri ),
              X( ialignment_of )( ego->ro ), ( INT )( ego->ii - ego->ri ),
              ( INT )( ego->io - ego->ro ), ego->sz, ego->vecsz );
}
...
problem* X( mkproblem_dft )( const tensor* sz, const tensor* vecsz, R* ri, R* ii, R* ro, R* io )
{
    problem_dft* ego;
...
problem* X( mkproblem_dft_d )( tensor* sz, tensor* vecsz, R* ri, R* ii, R* ro, R* io )
{
