...
/* Generated by: ../../../genfft/gen_notw.native -fma -compact -variables 4 -pipeline-latency 4 -n
 * 11 -name n1_11 -include dft/scalar/n.h */
...
static void n1_11( const R* ri, const R* ii, R* ro, R* io, stride is, stride os, INT v, INT ivs,
                   INT ovs )
{
    ...
    DK( KP342584725, +0.342584725681637509502641509861112333758894680 );
    {
        ...
        for ( i = v; i > 0; i = i - 1, ri = ri + ivs, ii = ii + ivs, ro = ro + ovs, io = io + ovs,
              MAKE_VOLATILE_STRIDE( 44, is ), MAKE_VOLATILE_STRIDE( 44, os ) )
        {
...
/* Generated by: ../../../genfft/gen_notw.native -compact -variables 4 -pipeline-latency 4 -n 11
 * -name n1_11 -include dft/scalar/n.h */
    ...
    DK( KP755749574, +0.755749574354258283774035843972344420179717445 );
    {
              ...
              MAKE_VOLATILE_STRIDE( 44, is ), MAKE_VOLATILE_STRIDE( 44, os ) )
        {
            ...
            }
            {
                ...
                Th = FMA( KP841253532, Ta, T1 ) + FNMS( KP959492973, Td, KP415415013 * Tg ) +
                     FNMA( KP142314838, T7, KP654860733 * T4 );
                ro[ WS( os, 7 ) ] = Th - Tx;
                ro[ WS( os, 4 ) ] = Th + Tx;
                TZ = FMA( KP755749574, TG, KP540640817 * TH ) +
                     FNMS( KP909631995, TI, KP281732556 * TJ ) - ( KP989821441 * TK );
                T10 = FMA( KP841253532, TQ, TM ) + FNMS( KP959492973, TO, KP415415013 * TP ) +
            ...
            }
            {
                ...
                TA = FMA( KP841253532, T4, T1 ) + FNMS( KP959492973, Tg, KP415415013 * T7 ) +
                ...
                TU = FMA( KP415415013, TQ, TM ) + FNMS( KP654860733, TP, KP841253532 * TO ) +
