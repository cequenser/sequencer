 ...
 * 14 -name n1_14 -include dft/scalar/n.h */
...
static void n1_14( const R* ri, const R* ii, R* ro, R* io, stride is, stride os, INT v, INT ivs,
                   INT ovs )
{
    ...
    DK( KP356895867, +0.356895867892209443894399510021300583399127187 );
    {
        ...
        for ( i = v; i > 0; i = i - 1, ri = ri + ivs, ii = ii + ivs, ro = ro + ovs, io = io + ovs,
              MAKE_VOLATILE_STRIDE( 56, is ), MAKE_VOLATILE_STRIDE( 56, os ) )
        {
...
/* Generated by: ../../../genfft/gen_notw.native -compact -variables 4 -pipeline-latency 4 -n 14
 * -name n1_14 -include dft/scalar/n.h */
