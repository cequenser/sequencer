 ...
 * 20 -name n1_20 -include dft/scalar/n.h */
...
static void n1_20( const R* ri, const R* ii, R* ro, R* io, stride is, stride os, INT v, INT ivs,
                   INT ovs )
{
    ...
    DK( KP250000000, +0.250000000000000000000000000000000000000000000 );
    {
        ...
        for ( i = v; i > 0; i = i - 1, ri = ri + ivs, ii = ii + ivs, ro = ro + ovs, io = io + ovs,
              MAKE_VOLATILE_STRIDE( 80, is ), MAKE_VOLATILE_STRIDE( 80, os ) )
        {
...
/* Generated by: ../../../genfft/gen_notw.native -compact -variables 4 -pipeline-latency 4 -n 20
 * -name n1_20 -include dft/scalar/n.h */
