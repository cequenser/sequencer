 ...
 * 25 -name n1_25 -include dft/scalar/n.h */
...
static void n1_25( const R* ri, const R* ii, R* ro, R* io, stride is, stride os, INT v, INT ivs,
                   INT ovs )
{
    ...
    DK( KP618033988, +0.618033988749894848204586834365638117720309180 );
    {
        ...
        for ( i = v; i > 0; i = i - 1, ri = ri + ivs, ii = ii + ivs, ro = ro + ovs, io = io + ovs,
              MAKE_VOLATILE_STRIDE( 100, is ), MAKE_VOLATILE_STRIDE( 100, os ) )
        {
...
/* Generated by: ../../../genfft/gen_notw.native -compact -variables 4 -pipeline-latency 4 -n 25
 * -name n1_25 -include dft/scalar/n.h */
