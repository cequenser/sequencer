...
/* Generated by: ../../../genfft/gen_notw.native -fma -compact -variables 4 -pipeline-latency 4 -n 8
 * -name n1_8 -include dft/scalar/n.h */
...
static void n1_8( const R* ri, const R* ii, R* ro, R* io, stride is, stride os, INT v, INT ivs,
                  INT ovs )
{
...
/* Generated by: ../../../genfft/gen_notw.native -compact -variables 4 -pipeline-latency 4 -n 8
 * -name n1_8 -include dft/scalar/n.h */
