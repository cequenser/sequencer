 ...
 * -reload-twiddle -dif -n 3 -name q1_3 -include dft/scalar/q.h */
...
static void q1_3( R* rio, R* iio, const R* W, stride rs, stride vs, INT mb, INT me, INT ms )
{
    ...
    {
        INT m;
        for ( m = mb, W = W + ( mb * 4 ); m < me; m = m + 1, rio = rio + ms, iio = iio + ms,
              W = W + 4, MAKE_VOLATILE_STRIDE( 6, rs ), MAKE_VOLATILE_STRIDE( 0, vs ) )
        {
