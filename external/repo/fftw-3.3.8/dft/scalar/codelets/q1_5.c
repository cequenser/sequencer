 ...
 * -reload-twiddle -dif -n 5 -name q1_5 -include dft/scalar/q.h */
...
static void q1_5( R* rio, R* iio, const R* W, stride rs, stride vs, INT mb, INT me, INT ms )
{
    ...
    {
        INT m;
        for ( m = mb, W = W + ( mb * 8 ); m < me; m = m + 1, rio = rio + ms, iio = iio + ms,
              W = W + 8, MAKE_VOLATILE_STRIDE( 10, rs ), MAKE_VOLATILE_STRIDE( 0, vs ) )
        {
