 ...
 * -reload-twiddle -dif -n 6 -name q1_6 -include dft/scalar/q.h */
...
static void q1_6( R* rio, R* iio, const R* W, stride rs, stride vs, INT mb, INT me, INT ms )
{
    ...
    {
        INT m;
        for ( m = mb, W = W + ( mb * 10 ); m < me; m = m + 1, rio = rio + ms, iio = iio + ms,
              W = W + 10, MAKE_VOLATILE_STRIDE( 12, rs ), MAKE_VOLATILE_STRIDE( 0, vs ) )
        {
