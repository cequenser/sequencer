...
/* Generated by: ../../../genfft/gen_twidsq.native -fma -compact -variables 4 -pipeline-latency 4
 * -reload-twiddle -dif -n 8 -name q1_8 -include dft/scalar/q.h */
...
static void q1_8( R* rio, R* iio, const R* W, stride rs, stride vs, INT mb, INT me, INT ms )
{
    ...
    {
        INT m;
        for ( m = mb, W = W + ( mb * 14 ); m < me; m = m + 1, rio = rio + ms, iio = iio + ms,
              W = W + 14, MAKE_VOLATILE_STRIDE( 16, rs ), MAKE_VOLATILE_STRIDE( 0, vs ) )
        {
...
/* Generated by: ../../../genfft/gen_twidsq.native -compact -variables 4 -pipeline-latency 4
 * -reload-twiddle -dif -n 8 -name q1_8 -include dft/scalar/q.h */
