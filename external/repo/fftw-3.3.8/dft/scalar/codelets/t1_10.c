 ...
 * -n 10 -name t1_10 -include dft/scalar/t.h */
...
static void t1_10( R* ri, R* ii, const R* W, stride rs, INT mb, INT me, INT ms )
{
    ...
    {
        INT m;
        for ( m = mb, W = W + ( mb * 18 ); m < me;
              m = m + 1, ri = ri + ms, ii = ii + ms, W = W + 18, MAKE_VOLATILE_STRIDE( 20, rs ) )
        {
...
/* Generated by: ../../../genfft/gen_twiddle.native -compact -variables 4 -pipeline-latency 4 -n 10
 * -name t1_10 -include dft/scalar/t.h */
