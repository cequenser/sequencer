 ...
 * -n 2 -name t1_2 -include dft/scalar/t.h */
...
{
    {
        ...
        for ( m = mb, W = W + ( mb * 2 ); m < me;
              m = m + 1, ri = ri + ms, ii = ii + ms, W = W + 2, MAKE_VOLATILE_STRIDE( 4, rs ) )
        {
...
/* Generated by: ../../../genfft/gen_twiddle.native -compact -variables 4 -pipeline-latency 4 -n 2
 * -name t1_2 -include dft/scalar/t.h */
