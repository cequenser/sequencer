 ...
 * -n 3 -name t1_3 -include dft/scalar/t.h */
...
static void t1_3( R* ri, R* ii, const R* W, stride rs, INT mb, INT me, INT ms )
{
    ...
    DK( KP500000000, +0.500000000000000000000000000000000000000000000 );
    {
        ...
        for ( m = mb, W = W + ( mb * 4 ); m < me;
              m = m + 1, ri = ri + ms, ii = ii + ms, W = W + 4, MAKE_VOLATILE_STRIDE( 6, rs ) )
        {
            E T1, Tm, T7, Th, Td, Tj;
            T1 = ri[ 0 ];
            Tm = ii[ 0 ];
...
/* Generated by: ../../../genfft/gen_twiddle.native -compact -variables 4 -pipeline-latency 4 -n 3
 * -name t1_3 -include dft/scalar/t.h */
