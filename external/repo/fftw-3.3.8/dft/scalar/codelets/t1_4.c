 ...
 * -n 4 -name t1_4 -include dft/scalar/t.h */
...
{
    {
        ...
        for ( m = mb, W = W + ( mb * 6 ); m < me;
              m = m + 1, ri = ri + ms, ii = ii + ms, W = W + 6, MAKE_VOLATILE_STRIDE( 8, rs ) )
        {
...
/* Generated by: ../../../genfft/gen_twiddle.native -compact -variables 4 -pipeline-latency 4 -n 4
 * -name t1_4 -include dft/scalar/t.h */
