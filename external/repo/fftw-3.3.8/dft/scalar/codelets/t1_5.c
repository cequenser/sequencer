 ...
 * -n 5 -name t1_5 -include dft/scalar/t.h */
...
static void t1_5( R* ri, R* ii, const R* W, stride rs, INT mb, INT me, INT ms )
{
    ...
    DK( KP250000000, +0.250000000000000000000000000000000000000000000 );
    {
        ...
        for ( m = mb, W = W + ( mb * 8 ); m < me;
              m = m + 1, ri = ri + ms, ii = ii + ms, W = W + 8, MAKE_VOLATILE_STRIDE( 10, rs ) )
        {
...
/* Generated by: ../../../genfft/gen_twiddle.native -compact -variables 4 -pipeline-latency 4 -n 5
 * -name t1_5 -include dft/scalar/t.h */
