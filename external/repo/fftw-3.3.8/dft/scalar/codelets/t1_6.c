 ...
 * -n 6 -name t1_6 -include dft/scalar/t.h */
...
static void t1_6( R* ri, R* ii, const R* W, stride rs, INT mb, INT me, INT ms )
{
    ...
    DK( KP500000000, +0.500000000000000000000000000000000000000000000 );
    {
        ...
        for ( m = mb, W = W + ( mb * 10 ); m < me;
              m = m + 1, ri = ri + ms, ii = ii + ms, W = W + 10, MAKE_VOLATILE_STRIDE( 12, rs ) )
        {
...
/* Generated by: ../../../genfft/gen_twiddle.native -compact -variables 4 -pipeline-latency 4 -n 6
 * -name t1_6 -include dft/scalar/t.h */
