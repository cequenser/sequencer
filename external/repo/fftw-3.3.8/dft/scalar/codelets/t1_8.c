 ...
 * -n 8 -name t1_8 -include dft/scalar/t.h */
...
static void t1_8( R* ri, R* ii, const R* W, stride rs, INT mb, INT me, INT ms )
{
    ...
    {
        INT m;
        for ( m = mb, W = W + ( mb * 14 ); m < me;
              m = m + 1, ri = ri + ms, ii = ii + ms, W = W + 14, MAKE_VOLATILE_STRIDE( 16, rs ) )
        {
...
/* Generated by: ../../../genfft/gen_twiddle.native -compact -variables 4 -pipeline-latency 4 -n 8
 * -name t1_8 -include dft/scalar/t.h */
