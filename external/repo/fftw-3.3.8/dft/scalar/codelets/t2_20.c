 ...
 * -twiddle-log3 -precompute-twiddles -n 20 -name t2_20 -include dft/scalar/t.h */
...
static void t2_20( R* ri, R* ii, const R* W, stride rs, INT mb, INT me, INT ms )
{
    ...
    {
        INT m;
        for ( m = mb, W = W + ( mb * 8 ); m < me;
              m = m + 1, ri = ri + ms, ii = ii + ms, W = W + 8, MAKE_VOLATILE_STRIDE( 40, rs ) )
        {
...
static const tw_instr twinstr[] = {
    {TW_CEXP, 0, 1}, {TW_CEXP, 0, 3}, {TW_CEXP, 0, 9}, {TW_CEXP, 0, 19}, {TW_NEXT, 1, 0}};
