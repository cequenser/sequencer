 ...
 * -twiddle-log3 -precompute-twiddles -n 25 -name t2_25 -include dft/scalar/t.h */
...
static void t2_25( R* ri, R* ii, const R* W, stride rs, INT mb, INT me, INT ms )
{
    ...
    DK( KP618033988, +0.618033988749894848204586834365638117720309180 );
    {
        ...
        for ( m = mb, W = W + ( mb * 8 ); m < me;
              m = m + 1, ri = ri + ms, ii = ii + ms, W = W + 8, MAKE_VOLATILE_STRIDE( 50, rs ) )
        {
...
static const tw_instr twinstr[] = {
    {TW_CEXP, 0, 1}, {TW_CEXP, 0, 3}, {TW_CEXP, 0, 9}, {TW_CEXP, 0, 24}, {TW_NEXT, 1, 0}};
