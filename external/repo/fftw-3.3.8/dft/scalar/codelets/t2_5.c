 ...
 * -twiddle-log3 -precompute-twiddles -n 5 -name t2_5 -include dft/scalar/t.h */
...
static void t2_5( R* ri, R* ii, const R* W, stride rs, INT mb, INT me, INT ms )
{
    ...
    DK( KP250000000, +0.250000000000000000000000000000000000000000000 );
    {
        ...
        for ( m = mb, W = W + ( mb * 4 ); m < me;
              m = m + 1, ri = ri + ms, ii = ii + ms, W = W + 4, MAKE_VOLATILE_STRIDE( 10, rs ) )
        {
...
static const tw_instr twinstr[] = {{TW_CEXP, 0, 1}, {TW_CEXP, 0, 3}, {TW_NEXT, 1, 0}};
