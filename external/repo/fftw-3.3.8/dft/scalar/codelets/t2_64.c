...
/* Generated by: ../../../genfft/gen_twiddle.native -fma -compact -variables 4 -pipeline-latency 4
 * -twiddle-log3 -precompute-twiddles -n 64 -name t2_64 -include dft/scalar/t.h */
...
static void t2_64( R* ri, R* ii, const R* W, stride rs, INT mb, INT me, INT ms )
{
    ...
    {
        INT m;
        for ( m = mb, W = W + ( mb * 10 ); m < me;
              m = m + 1, ri = ri + ms, ii = ii + ms, W = W + 10, MAKE_VOLATILE_STRIDE( 128, rs ) )
        {
...
static const tw_instr twinstr[] = {{TW_CEXP, 0, 1},  {TW_CEXP, 0, 3},  {TW_CEXP, 0, 9},
                                   {TW_CEXP, 0, 27}, {TW_CEXP, 0, 63}, {TW_NEXT, 1, 0}};
...
/* Generated by: ../../../genfft/gen_twiddle.native -compact -variables 4 -pipeline-latency 4
 * -twiddle-log3 -precompute-twiddles -n 64 -name t2_64 -include dft/scalar/t.h */
