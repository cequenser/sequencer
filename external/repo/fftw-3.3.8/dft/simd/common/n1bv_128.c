...
static void n1bv_128( const R* ri, const R* ii, R* ro, R* io, stride is, stride os, INT v, INT ivs,
                      INT ovs )
{
...
static const kdft_desc desc = {128, XSIMD_STRING( "n1bv_128" ), {440, 0, 642, 0}, &GENUS, 0, 0, 0,
                               0};
 ...
 * -sign 1 -n 128 -name n1bv_128 -include dft/simd/n1b.h */
...
static const kdft_desc desc = {128, XSIMD_STRING( "n1bv_128" ), {938, 186, 144, 0}, &GENUS, 0, 0, 0,
                               0};
