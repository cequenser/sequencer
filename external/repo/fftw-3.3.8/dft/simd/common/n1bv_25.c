...
static void n1bv_25( const R* ri, const R* ii, R* ro, R* io, stride is, stride os, INT v, INT ivs,
                     INT ovs )
{
            ...
            }
            {
                ...
                }
                {
                    ...
                    ST( &( xo[ WS( os, 18 ) ] ), VFMAI( T3m, T3j ), ovs, &( xo[ 0 ] ) );
                    {
                        ...
                        ST( &( xo[ WS( os, 17 ) ] ), VFNMSI( T2M, T2G ), ovs,
                            &( xo[ WS( os, 1 ) ] ) );
                    }
                }
            }
            {
                ...
                }
                {
                    ...
                    ST( &( xo[ WS( os, 14 ) ] ), VFNMSI( T1G, T1D ), ovs, &( xo[ 0 ] ) );
                    {
                        ...
                        ST( &( xo[ WS( os, 9 ) ] ), VFNMSI( T2a, T24 ), ovs,
                            &( xo[ WS( os, 1 ) ] ) );
 ...
 * -sign 1 -n 25 -name n1bv_25 -include dft/simd/n1b.h */
    ...
    DVK( KP559016994, +0.559016994374947424102293417182819058860154590 );
    {
              ...
              MAKE_VOLATILE_STRIDE( 50, is ), MAKE_VOLATILE_STRIDE( 50, os ) )
        {
            ...
            }
            {
                ...
                T2r = VBYI( VADD( VFMA( LDK( KP951056516 ), T2i, VMUL( LDK( KP587785252 ), T2j ) ),
                                  VADD( T2m, T2q ) ) );
            ...
            }
            {
                ...
                T1y = VBYI( VADD( VFMA( LDK( KP951056516 ), T1m, VMUL( LDK( KP587785252 ), T1n ) ),
                                  VADD( T1q, T1x ) ) );
