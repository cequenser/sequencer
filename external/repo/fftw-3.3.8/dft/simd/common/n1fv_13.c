...
static void n1fv_13( const R* ri, const R* ii, R* ro, R* io, stride is, stride os, INT v, INT ivs,
                     INT ovs )
{
            ...
            ST( &( xo[ 0 ] ), VADD( T1, To ), ovs, &( xo[ 0 ] ) );
            {
                ...
                }
                {
                    ...
                    ST( &( xo[ WS( os, 8 ) ] ), VFMAI( T10, TJ ), ovs, &( xo[ 0 ] ) );
                    {
                        ...
                        ST( &( xo[ WS( os, 1 ) ] ), VFMAI( T16, T11 ), ovs,
                            &( xo[ WS( os, 1 ) ] ) );
                        ...
                        ST( &( xo[ WS( os, 11 ) ] ), VFMAI( T1q, T1p ), ovs,
                            &( xo[ WS( os, 1 ) ] ) );
                    }
                    ...
                    ST( &( xo[ WS( os, 7 ) ] ), VFMAI( T1o, T1l ), ovs, &( xo[ WS( os, 1 ) ] ) );
                    {
                        ...
                        ST( &( xo[ WS( os, 3 ) ] ), VFMAI( T1i, T1h ), ovs,
                            &( xo[ WS( os, 1 ) ] ) );
                        ...
                        ST( &( xo[ WS( os, 9 ) ] ), VFMAI( T1g, T1d ), ovs,
                            &( xo[ WS( os, 1 ) ] ) );
                    }
                }
            }
 ...
 * -n 13 -name n1fv_13 -include dft/simd/n1f.h */
            ...
            ST( &( xo[ 0 ] ), VADD( TW, TX ), ovs, &( xo[ 0 ] ) );
            {
                ...
                }
                {
                    ...
                    ST( &( xo[ WS( os, 10 ) ] ), VSUB( T1o, T1l ), ovs, &( xo[ 0 ] ) );
                    {
                        ...
                        ST( &( xo[ WS( os, 11 ) ] ), VADD( T1g, T1d ), ovs,
                            &( xo[ WS( os, 1 ) ] ) );
                    }
                }
            }
