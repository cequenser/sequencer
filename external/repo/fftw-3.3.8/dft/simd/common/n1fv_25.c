...
static void n1fv_25( const R* ri, const R* ii, R* ro, R* io, stride is, stride os, INT v, INT ivs,
                     INT ovs )
{
            ...
            }
            {
                ...
                }
                {
                    ...
                    ST( &( xo[ WS( os, 7 ) ] ), VFMAI( T3m, T3j ), ovs, &( xo[ WS( os, 1 ) ] ) );
                    {
                        ...
                        ST( &( xo[ WS( os, 17 ) ] ), VFMAI( T2M, T2G ), ovs,
                            &( xo[ WS( os, 1 ) ] ) );
                    }
                }
            }
            {
                ...
                }
                {
                    ...
                    ST( &( xo[ WS( os, 14 ) ] ), VFMAI( T1G, T1D ), ovs, &( xo[ 0 ] ) );
                    {
                        ...
                        ST( &( xo[ WS( os, 9 ) ] ), VFMAI( T2a, T24 ), ovs,
                            &( xo[ WS( os, 1 ) ] ) );
                    }
                }
            }
 ...
 * -n 25 -name n1fv_25 -include dft/simd/n1f.h */
              ...
              MAKE_VOLATILE_STRIDE( 50, is ), MAKE_VOLATILE_STRIDE( 50, os ) )
        {
            ...
            }
            {
                ...
                ST( &( xo[ WS( os, 18 ) ] ), VSUB( T2F, T2x ), ovs, &( xo[ 0 ] ) );
                {
                    V T2G, T2H, T2g, T2h;
                    T2G = VBYI( VADD(
                        T2q, VSUB( VFMA( LDK( KP587785252 ), T2t, VMUL( LDK( KP951056516 ), T2w ) ),
                                   T2o ) ) );
            ...
            }
            {
                ...
                T1t = VBYI( VADD( VFMA( LDK( KP587785252 ), T1p, VMUL( LDK( KP951056516 ), T1q ) ),
                                  VSUB( T1r, T1s ) ) );
                ...
                ST( &( xo[ WS( os, 14 ) ] ), VSUB( T1y, T1t ), ovs, &( xo[ 0 ] ) );
                {
                    ...
                    T1P = VBYI(
                        VADD( T1g, VFMA( LDK( KP309016994 ), T1K,
