...
static void n1fv_9( const R* ri, const R* ii, R* ro, R* io, stride is, stride os, INT v, INT ivs,
                    INT ovs )
{
 ...
 * -n 9 -name n1fv_9 -include dft/simd/n1f.h */
            ...
            }
            {
                ...
                Tz = VFMA(
                    ...
                    VFNMS( LDK( KP296198132 ), To,
                           VFNMS( LDK( KP939692620 ), Tn, VFNMS( LDK( KP852868531 ), Tl, Tj ) ) ) );
