 ...
 * -pipeline-latency 8 -sign 1 -n 14 -name n2bv_14 -with-ostride 2 -include dft/simd/n2b.h
 * -store-multiple 2 */
...
static void n2bv_14( const R* ri, const R* ii, R* ro, R* io, stride is, stride os, INT v, INT ivs,
                     INT ovs )
{
 ...
 * -sign 1 -n 14 -name n2bv_14 -with-ostride 2 -include dft/simd/n2b.h -store-multiple 2 */
                    ...
                    STM2( &( xo[ 16 ] ), T10, ovs, &( xo[ 0 ] ) );
                    {
                        ...
                        STN2( &( xo[ 20 ] ), T12, TU, ovs );
                        {
                            ...
                            Tw = VFMA( LDK( KP623489801 ), Tr,
                                       VFNMS( LDK( KP900968867 ), Tq,
                                              VFNMS( LDK( KP222520933 ), Ts, Tp ) ) );
                            T13 = VSUB( Tw, Tx );
