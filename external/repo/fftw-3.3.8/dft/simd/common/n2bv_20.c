 ...
 * -pipeline-latency 8 -sign 1 -n 20 -name n2bv_20 -with-ostride 2 -include dft/simd/n2b.h
 * -store-multiple 2 */
...
static void n2bv_20( const R* ri, const R* ii, R* ro, R* io, stride is, stride os, INT v, INT ivs,
                     INT ovs )
{
 ...
 * -sign 1 -n 20 -name n2bv_20 -with-ostride 2 -include dft/simd/n2b.h -store-multiple 2 */
            ...
            }
            {
                ...
                }
                {
                    V T1O, T1P, T1R, T1S;
                    {
                        ...
                        T1e = VSUB( T1a, T1d );
                        T1f = VBYI(
                            VFNMS( LDK( KP951056516 ), T1e, VMUL( LDK( KP587785252 ), T17 ) ) );
                        T1p = VBYI(
                            VFMA( LDK( KP951056516 ), T17, VMUL( LDK( KP587785252 ), T1e ) ) );
                        T1O = VADD( T1i, T1l );
                        STM2( &( xo[ 20 ] ), T1O, ovs, &( xo[ 0 ] ) );
                        T1q = VADD( T1n, T1m );
                        T1P = VADD( T1p, T1q );
