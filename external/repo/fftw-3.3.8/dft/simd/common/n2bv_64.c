 ...
 * -pipeline-latency 8 -sign 1 -n 64 -name n2bv_64 -with-ostride 2 -include dft/simd/n2b.h
 * -store-multiple 2 */
...
static void n2bv_64( const R* ri, const R* ii, R* ro, R* io, stride is, stride os, INT v, INT ivs,
                     INT ovs )
{
 ...
 * -sign 1 -n 64 -name n2bv_64 -with-ostride 2 -include dft/simd/n2b.h -store-multiple 2 */
                    ...
                    }
                    {
                        V T81, T83, T86, T88;
                        {
                            V T4N, T5G, T5z, T5H, T5m, T5D, T5w, T5E;
                            {
                                ...
                                T4N = VSUB( T4x, T4M );
                                T5G = VADD( T4x, T4M );
                                T5x = VFNMS( LDK( KP555570233 ), T4Y,
                                             VMUL( LDK( KP831469612 ), T53 ) );
                                T5y = VFMA( LDK( KP555570233 ), T5f,
                                            VMUL( LDK( KP831469612 ), T5k ) );
                                T5z = VSUB( T5x, T5y );
                                T5H = VADD( T5x, T5y );
                            }
                            {
                                V T54, T5l, T5q, T5v;
                                T54 = VFMA( LDK( KP831469612 ), T4Y,
                                            VMUL( LDK( KP555570233 ), T53 ) );
                                T5l = VFNMS( LDK( KP555570233 ), T5k,
                                             VMUL( LDK( KP831469612 ), T5f ) );
                                T5m = VSUB( T54, T5l );
                                T5D = VADD( T54, T5l );
                                T5q = VSUB( T5o, T5p );
                                T5v = VSUB( T5r, T5u );
                        ...
                        }
                        {
                            V T2J, T34, T2X, T35, T2Q, T31, T2U, T32;
                            {
                                ...
                                T2J = VSUB( T2H, T2I );
                                T34 = VADD( T2H, T2I );
                                T2V = VFNMS( LDK( KP290284677 ), T2K,
                                             VMUL( LDK( KP956940335 ), T2L ) );
                                T2W = VFMA( LDK( KP290284677 ), T2N,
                                            VMUL( LDK( KP956940335 ), T2O ) );
                                T2X = VSUB( T2V, T2W );
                                T35 = VADD( T2V, T2W );
                            }
                            {
                                V T2M, T2P, T2S, T2T;
                                T2M = VFMA( LDK( KP956940335 ), T2K,
                                            VMUL( LDK( KP290284677 ), T2L ) );
                                T2P = VFNMS( LDK( KP290284677 ), T2O,
                                             VMUL( LDK( KP956940335 ), T2N ) );
                                T2Q = VSUB( T2M, T2P );
                                T31 = VADD( T2M, T2P );
                                T2S = VADD( TI, TZ );
                                T2T = VADD( T2q, T2l );
                        ...
                        }
                        {
                            ...
                            {
                                V T3X, T40, T49, T4a;
                                T3X = VFNMS( LDK( KP634393284 ), T3W,
                                             VMUL( LDK( KP773010453 ), T3V ) );
                                T40 = VFMA( LDK( KP773010453 ), T3Y,
                                            VMUL( LDK( KP634393284 ), T3Z ) );
                                T41 = VSUB( T3X, T40 );
                                T4g = VADD( T3X, T40 );
                                T49 = VFMA( LDK( KP634393284 ), T3V,
                                            VMUL( LDK( KP773010453 ), T3W ) );
                                T4a = VFNMS( LDK( KP634393284 ), T3Y,
                                             VMUL( LDK( KP773010453 ), T3Z ) );
                                T4b = VSUB( T49, T4a );
                                T4j = VADD( T49, T4a );
                            }
                            {
