 ...
 * -pipeline-latency 8 -sign 1 -n 8 -name n2bv_8 -with-ostride 2 -include dft/simd/n2b.h
 * -store-multiple 2 */
...
static void n2bv_8( const R* ri, const R* ii, R* ro, R* io, stride is, stride os, INT v, INT ivs,
                    INT ovs )
{
 ...
 * -sign 1 -n 8 -name n2bv_8 -with-ostride 2 -include dft/simd/n2b.h -store-multiple 2 */
