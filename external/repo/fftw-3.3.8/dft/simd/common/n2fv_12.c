 ...
 * -pipeline-latency 8 -n 12 -name n2fv_12 -with-ostride 2 -include dft/simd/n2f.h -store-multiple 2
 */
...
static void n2fv_12( const R* ri, const R* ii, R* ro, R* io, stride is, stride os, INT v, INT ivs,
                     INT ovs )
{
 ...
 * -n 12 -name n2fv_12 -with-ostride 2 -include dft/simd/n2f.h -store-multiple 2 */
