 ...
 * -pipeline-latency 8 -n 64 -name n2fv_64 -with-ostride 2 -include dft/simd/n2f.h -store-multiple 2
 */
...
static void n2fv_64( const R* ri, const R* ii, R* ro, R* io, stride is, stride os, INT v, INT ivs,
                     INT ovs )
{
 ...
 * -n 64 -name n2fv_64 -with-ostride 2 -include dft/simd/n2f.h -store-multiple 2 */
                    ...
                    }
                    {
                        V T81, T83, T86, T88;
                        {
                            V T4N, T5G, T5z, T5H, T5m, T5D, T5w, T5E;
                            {
                                ...
                                T4N = VADD( T4x, T4M );
                                T5G = VSUB( T4x, T4M );
                                T5x = VFNMS( LDK( KP195090322 ), T4Y,
                                             VMUL( LDK( KP980785280 ), T53 ) );
                                T5y = VFMA( LDK( KP195090322 ), T5f,
                                            VMUL( LDK( KP980785280 ), T5k ) );
                                T5z = VADD( T5x, T5y );
                                T5H = VSUB( T5y, T5x );
                            }
                            {
                                V T54, T5l, T5s, T5v;
                                T54 = VFMA( LDK( KP980785280 ), T4Y,
                                            VMUL( LDK( KP195090322 ), T53 ) );
                                T5l = VFNMS( LDK( KP195090322 ), T5k,
                                             VMUL( LDK( KP980785280 ), T5f ) );
                                T5m = VADD( T54, T5l );
                                T5D = VSUB( T5l, T54 );
                                T5s = VADD( T5q, T5r );
                                T5v = VADD( T5t, T5u );
                        ...
                        }
                        {
                            V T2J, T34, T2X, T35, T2Q, T31, T2U, T32;
                            {
                                ...
                                T2J = VADD( T2H, T2I );
                                T34 = VSUB( T2H, T2I );
                                T2V = VFNMS( LDK( KP098017140 ), T2L,
                                             VMUL( LDK( KP995184726 ), T2K ) );
                                T2W = VFMA( LDK( KP995184726 ), T2O,
                                            VMUL( LDK( KP098017140 ), T2N ) );
                                T2X = VADD( T2V, T2W );
                                T35 = VSUB( T2W, T2V );
                            }
                            {
                                V T2M, T2P, T2S, T2T;
                                T2M = VFMA( LDK( KP098017140 ), T2K,
                                            VMUL( LDK( KP995184726 ), T2L ) );
                                T2P = VFNMS( LDK( KP098017140 ), T2O,
                                             VMUL( LDK( KP995184726 ), T2N ) );
                                T2Q = VADD( T2M, T2P );
                                T31 = VSUB( T2P, T2M );
                                T2S = VADD( T2n, T2i );
                                T2T = VADD( TZ, TI );
                        ...
                        }
                        {
                            V T3X, T4i, T4b, T4j, T44, T4f, T48, T4g;
                            {
                                ...
                                T3X = VADD( T3V, T3W );
                                T4i = VSUB( T3V, T3W );
                                T49 = VFNMS( LDK( KP471396736 ), T3Y,
                                             VMUL( LDK( KP881921264 ), T3Z ) );
                                T4a = VFMA( LDK( KP471396736 ), T41,
                                            VMUL( LDK( KP881921264 ), T42 ) );
                                T4b = VADD( T49, T4a );
                                T4j = VSUB( T4a, T49 );
                            }
                            {
                                V T40, T43, T46, T47;
                                T40 = VFMA( LDK( KP881921264 ), T3Y,
                                            VMUL( LDK( KP471396736 ), T3Z ) );
                                T43 = VFNMS( LDK( KP471396736 ), T42,
                                             VMUL( LDK( KP881921264 ), T41 ) );
                                T44 = VADD( T40, T43 );
                                T4f = VSUB( T43, T40 );
                                T46 = VSUB( T3B, T3A );
                                T47 = VSUB( T3h, T3e );
