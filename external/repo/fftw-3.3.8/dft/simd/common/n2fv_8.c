 ...
 * -pipeline-latency 8 -n 8 -name n2fv_8 -with-ostride 2 -include dft/simd/n2f.h -store-multiple 2
 */
...
static void n2fv_8( const R* ri, const R* ii, R* ro, R* io, stride is, stride os, INT v, INT ivs,
                    INT ovs )
{
 ...
 * -n 8 -name n2fv_8 -with-ostride 2 -include dft/simd/n2f.h -store-multiple 2 */
