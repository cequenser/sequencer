 ...
 * 8 -n 16 -name n2sv_16 -with-ostride 1 -include dft/simd/n2s.h -store-multiple 4 */
...
static void n2sv_16( const R* ri, const R* ii, R* ro, R* io, stride is, stride os, INT v, INT ivs,
                     INT ovs )
{
 ...
 * 16 -name n2sv_16 -with-ostride 1 -include dft/simd/n2s.h -store-multiple 4 */
                ...
                }
                {
                    ...
                    }
                    {
                        V T2B, T2C, T2D, T2E, T2F, T2G, T2H, T2I;
                        {
                            ...
                            {
                                V T16, T1h, T1s, T1t;
                                T16 = VFMA( LDK( KP923879532 ), T10,
                                            VMUL( LDK( KP382683432 ), T15 ) );
                                T1h = VFNMS( LDK( KP923879532 ), T1g,
                                             VMUL( LDK( KP382683432 ), T1b ) );
                                T1i = VADD( T16, T1h );
                                T1q = VSUB( T1h, T16 );
                                T1s = VFNMS( LDK( KP923879532 ), T15,
                                             VMUL( LDK( KP382683432 ), T10 ) );
                                T1t = VFMA( LDK( KP382683432 ), T1g,
                                            VMUL( LDK( KP923879532 ), T1b ) );
                                T1u = VSUB( T1s, T1t );
                                T1w = VADD( T1s, T1t );
                            }
                            T2B = VSUB( TV, T1i );
                        ...
                        }
                        {
                            ...
                            {
                                V T1C, T1F, T1M, T1N;
                                T1C = VFMA( LDK( KP382683432 ), T1A,
                                            VMUL( LDK( KP923879532 ), T1B ) );
                                T1F = VFNMS( LDK( KP382683432 ), T1E,
                                             VMUL( LDK( KP923879532 ), T1D ) );
                                T1G = VADD( T1C, T1F );
                                T1K = VSUB( T1F, T1C );
                                T1M = VFNMS( LDK( KP382683432 ), T1B,
                                             VMUL( LDK( KP923879532 ), T1A ) );
                                T1N = VFMA( LDK( KP923879532 ), T1E,
                                            VMUL( LDK( KP382683432 ), T1D ) );
                                T1O = VSUB( T1M, T1N );
                                T1Q = VADD( T1M, T1N );
                            }
                            {
