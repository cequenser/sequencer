 ...
 * 8 -n 4 -name n2sv_4 -with-ostride 1 -include dft/simd/n2s.h -store-multiple 4 */
...
static void n2sv_4( const R* ri, const R* ii, R* ro, R* io, stride is, stride os, INT v, INT ivs,
                    INT ovs )
{
    {
        INT i;
 ...
 * 4 -name n2sv_4 -with-ostride 1 -include dft/simd/n2s.h -store-multiple 4 */
