...
/* Generated by: ../../../genfft/gen_notw.native -fma -simd -compact -variables 4 -pipeline-latency
 * 8 -n 64 -name n2sv_64 -with-ostride 1 -include dft/simd/n2s.h -store-multiple 4 */
...
static void n2sv_64( const R* ri, const R* ii, R* ro, R* io, stride is, stride os, INT v, INT ivs,
                     INT ovs )
{
            ...
            }
            {
                ...
                }
                {
                    ...
                    }
                    {
                        ...
                        V Tgw;
                        {
                            V T3v, T6j, T6o, T6y, T6r, T6z, T48, T6u, T52, T6f, T67, T6t, T6a, T6k,
                                T5V;
                            V T6e;
                            {
                                V T3f, T3u, T6m, T6n;
                        ...
                        {
                            V T7L, T8X, T92, T9c, T95, T9d, T80, T98, T8k, T8T, T8L, T97, T8O, T8Y,
                                T8D;
                            V T8S;
                            {
                                V T7D, T7K, T90, T91;
...
/* Generated by: ../../../genfft/gen_notw.native -simd -compact -variables 4 -pipeline-latency 8 -n
 * 64 -name n2sv_64 -with-ostride 1 -include dft/simd/n2s.h -store-multiple 4 */
            ...
            }
            {
                ...
                }
                {
                    ...
                    }
                    {
                        ...
                        V Tgw;
                        {
                            V T3v, T6j, T6o, T6y, T6r, T6z, T48, T6u, T52, T6e, T67, T6t, T6a, T6k,
                                T5V;
                            V T6f;
                            {
                                V T3f, T3u, T6m, T6n;
                                ...
                                T6m = VADD( T4q, T4N );
                                T6n = VADD( T4X, T50 );
                                T6o = VFMA( LDK( KP634393284 ), T6m,
                                            VMUL( LDK( KP773010453 ), T6n ) );
                                T6y = VFNMS( LDK( KP634393284 ), T6n,
                                             VMUL( LDK( KP773010453 ), T6m ) );
                            }
                            {
                                V T6p, T6q, T3O, T47;
                                T6p = VADD( T5j, T5G );
                                T6q = VADD( T5Q, T5T );
                                T6r = VFNMS( LDK( KP634393284 ), T6q,
                                             VMUL( LDK( KP773010453 ), T6p ) );
                                T6z = VFMA( LDK( KP773010453 ), T6q,
                                            VMUL( LDK( KP634393284 ), T6p ) );
                                T3O = VFNMS( LDK( KP980785280 ), T3N,
                                             VMUL( LDK( KP195090322 ), T3G ) );
                                T47 = VFMA( LDK( KP195090322 ), T3Z,
                                            VMUL( LDK( KP980785280 ), T46 ) );
                                T48 = VSUB( T3O, T47 );
                                T6u = VADD( T3O, T47 );
                            }
                            {
                                ...
                                T4O = VSUB( T4q, T4N );
                                T51 = VSUB( T4X, T50 );
                                T52 = VFMA( LDK( KP995184726 ), T4O,
                                            VMUL( LDK( KP098017140 ), T51 ) );
                                T6e = VFNMS( LDK( KP995184726 ), T51,
                                             VMUL( LDK( KP098017140 ), T4O ) );
                                T63 = VSUB( T5Z, T62 );
                                T66 = VSUB( T64, T65 );
                                T67 = VSUB( T63, T66 );
                                T6t = VADD( T63, T66 );
                            ...
                            {
                                V T68, T69, T5H, T5U;
                                T68 = VFNMS( LDK( KP980785280 ), T3Z,
                                             VMUL( LDK( KP195090322 ), T46 ) );
                                T69 = VFMA( LDK( KP980785280 ), T3G,
                                            VMUL( LDK( KP195090322 ), T3N ) );
                                T6a = VSUB( T68, T69 );
                                T6k = VADD( T69, T68 );
                                T5H = VSUB( T5j, T5G );
                                T5U = VSUB( T5Q, T5T );
                                T5V = VFNMS( LDK( KP995184726 ), T5U,
                                             VMUL( LDK( KP098017140 ), T5H ) );
                                T6f = VFMA( LDK( KP098017140 ), T5U,
                                            VMUL( LDK( KP995184726 ), T5H ) );
                            }
                            {
                                V T49, T5W, T6h, T6i;
                                T49 = VADD( T3v, T48 );
                        ...
                        {
                            V T7L, T8X, T92, T9c, T95, T9d, T80, T98, T8k, T8S, T8L, T97, T8O, T8Y,
                                T8D;
                            V T8T;
                            {
                                V T7D, T7K, T90, T91;
                                ...
                                T90 = VADD( T84, T8b );
                                T91 = VADD( T8f, T8i );
                                T92 = VFMA( LDK( KP471396736 ), T90,
                                            VMUL( LDK( KP881921264 ), T91 ) );
                                T9c = VFNMS( LDK( KP471396736 ), T91,
                                             VMUL( LDK( KP881921264 ), T90 ) );
                            }
                            {
                                V T93, T94, T7S, T7Z;
                                T93 = VADD( T8n, T8u );
                                T94 = VADD( T8y, T8B );
                                T95 = VFNMS( LDK( KP471396736 ), T94,
                                             VMUL( LDK( KP881921264 ), T93 ) );
                                T9d = VFMA( LDK( KP881921264 ), T94,
                                            VMUL( LDK( KP471396736 ), T93 ) );
                                T7S = VFNMS( LDK( KP831469612 ), T7R,
                                             VMUL( LDK( KP555570233 ), T7O ) );
                                T7Z = VFMA( LDK( KP831469612 ), T7V,
                                            VMUL( LDK( KP555570233 ), T7Y ) );
                                T80 = VSUB( T7S, T7Z );
                                T98 = VADD( T7S, T7Z );
                            }
                            {
                                ...
                                T8c = VSUB( T84, T8b );
                                T8j = VSUB( T8f, T8i );
                                T8k = VFMA( LDK( KP956940335 ), T8c,
                                            VMUL( LDK( KP290284677 ), T8j ) );
                                T8S = VFNMS( LDK( KP956940335 ), T8j,
                                             VMUL( LDK( KP290284677 ), T8c ) );
                                T8H = VSUB( T8F, T8G );
                                T8K = VSUB( T8I, T8J );
                                T8L = VSUB( T8H, T8K );
                                T97 = VADD( T8H, T8K );
                            ...
                            {
                                V T8M, T8N, T8v, T8C;
                                T8M = VFNMS( LDK( KP831469612 ), T7Y,
                                             VMUL( LDK( KP555570233 ), T7V ) );
                                T8N = VFMA( LDK( KP555570233 ), T7R,
                                            VMUL( LDK( KP831469612 ), T7O ) );
                                T8O = VSUB( T8M, T8N );
                                T8Y = VADD( T8N, T8M );
                                T8v = VSUB( T8n, T8u );
                                T8C = VSUB( T8y, T8B );
                                T8D = VFNMS( LDK( KP956940335 ), T8C,
                                             VMUL( LDK( KP290284677 ), T8v ) );
                                T8T = VFMA( LDK( KP290284677 ), T8C,
                                            VMUL( LDK( KP956940335 ), T8v ) );
                            }
                            {
                                V T81, T8E, Tgx, Tgy;
                                T81 = VADD( T7L, T80 );
...
static const kdft_desc desc = {64, XSIMD_STRING( "n2sv_64" ), {808, 144, 104, 0}, &GENUS, 0, 1, 0,
                               0};
