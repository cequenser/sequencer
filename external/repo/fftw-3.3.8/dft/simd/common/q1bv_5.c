              ...
              MAKE_VOLATILE_STRIDE( 10, vs ) )
        {
            ...
            }
            {
                ...
                T1j = LD( &( x[ WS( vs, 4 ) ] ), ms, &( x[ WS( vs, 4 ) ] ) );
                {
                    ...
                    T1o = LD( &( x[ WS( vs, 4 ) + WS( rs, 3 ) ] ), ms,
                              &( x[ WS( vs, 4 ) + WS( rs, 1 ) ] ) );
                    T1p = VADD( T1n, T1o );
                    T1v = VSUB( T1n, T1o );
                    T1k = LD( &( x[ WS( vs, 4 ) + WS( rs, 1 ) ] ), ms,
                              &( x[ WS( vs, 4 ) + WS( rs, 1 ) ] ) );
            ...
            }
            {
                ...
                Tl = LD( &( x[ WS( vs, 1 ) ] ), ms, &( x[ WS( vs, 1 ) ] ) );
                {
                    ...
                    Tq = LD( &( x[ WS( vs, 1 ) + WS( rs, 3 ) ] ), ms,
                             &( x[ WS( vs, 1 ) + WS( rs, 1 ) ] ) );
                    Tr = VADD( Tp, Tq );
                    Tx = VSUB( Tp, Tq );
                    Tm = LD( &( x[ WS( vs, 1 ) + WS( rs, 1 ) ] ), ms,
                             &( x[ WS( vs, 1 ) + WS( rs, 1 ) ] ) );
            ...
            }
            {
                ...
                TF = LD( &( x[ WS( vs, 2 ) ] ), ms, &( x[ WS( vs, 2 ) ] ) );
                {
                    ...
                    TK = LD( &( x[ WS( vs, 2 ) + WS( rs, 3 ) ] ), ms,
                             &( x[ WS( vs, 2 ) + WS( rs, 1 ) ] ) );
                    TL = VADD( TJ, TK );
                    TR = VSUB( TJ, TK );
                    TG = LD( &( x[ WS( vs, 2 ) + WS( rs, 1 ) ] ), ms,
                             &( x[ WS( vs, 2 ) + WS( rs, 1 ) ] ) );
            ...
            }
            {
                ...
                TZ = LD( &( x[ WS( vs, 3 ) ] ), ms, &( x[ WS( vs, 3 ) ] ) );
                {
                    ...
                    T14 = LD( &( x[ WS( vs, 3 ) + WS( rs, 3 ) ] ), ms,
                              &( x[ WS( vs, 3 ) + WS( rs, 1 ) ] ) );
                    T15 = VADD( T13, T14 );
                    T1b = VSUB( T13, T14 );
                    T10 = LD( &( x[ WS( vs, 3 ) + WS( rs, 1 ) ] ), ms,
                              &( x[ WS( vs, 3 ) + WS( rs, 1 ) ] ) );
            ...
            }
            {
                ...
                ST( &( x[ WS( vs, 2 ) + WS( rs, 3 ) ] ), T1h, ms,
                    &( x[ WS( vs, 2 ) + WS( rs, 1 ) ] ) );
                ST( &( x[ WS( vs, 3 ) + WS( rs, 3 ) ] ), T1i, ms,
                    &( x[ WS( vs, 3 ) + WS( rs, 1 ) ] ) );
                TB = VFNMS( LDK( KP559016994 ), Tu, Tt );
                TD = BYTW( &( W[ TWVL * 2 ] ), VFNMSI( TC, TB ) );
                TE = BYTW( &( W[ TWVL * 4 ] ), VFMAI( TC, TB ) );
                ST( &( x[ WS( vs, 2 ) + WS( rs, 1 ) ] ), TD, ms,
                    &( x[ WS( vs, 2 ) + WS( rs, 1 ) ] ) );
                ST( &( x[ WS( vs, 3 ) + WS( rs, 1 ) ] ), TE, ms,
                    &( x[ WS( vs, 3 ) + WS( rs, 1 ) ] ) );
            }
            {
                V TX, TY, TV, TT, TU, TP;
            ...
            }
            {
                ...
                ST( &( x[ WS( vs, 1 ) + WS( rs, 1 ) ] ), Tz, ms,
                    &( x[ WS( vs, 1 ) + WS( rs, 1 ) ] ) );
                ST( &( x[ WS( vs, 4 ) + WS( rs, 1 ) ] ), TA, ms,
                    &( x[ WS( vs, 4 ) + WS( rs, 1 ) ] ) );
            }
            {
                ...
                ST( &( x[ WS( vs, 1 ) + WS( rs, 3 ) ] ), T1d, ms,
                    &( x[ WS( vs, 1 ) + WS( rs, 1 ) ] ) );
                ST( &( x[ WS( vs, 4 ) + WS( rs, 3 ) ] ), T1e, ms,
                    &( x[ WS( vs, 4 ) + WS( rs, 1 ) ] ) );
...
static const ct_desc desc = {5, XSIMD_STRING( "q1bv_5" ), twinstr, &GENUS, {55, 50, 45, 0}, 0, 0,
                             0};
 ...
 * -n 5 -dif -name q1bv_5 -include dft/simd/q1b.h -sign 1 */
              ...
              MAKE_VOLATILE_STRIDE( 10, vs ) )
        {
            ...
            }
            {
                ...
                T1t = LD( &( x[ WS( vs, 4 ) ] ), ms, &( x[ WS( vs, 4 ) ] ) );
                {
                    ...
                    T1n = LD( &( x[ WS( vs, 4 ) + WS( rs, 3 ) ] ), ms,
                              &( x[ WS( vs, 4 ) + WS( rs, 1 ) ] ) );
                    T1o = VSUB( T1m, T1n );
                    T1r = VADD( T1m, T1n );
                    T1j = LD( &( x[ WS( vs, 4 ) + WS( rs, 1 ) ] ), ms,
                              &( x[ WS( vs, 4 ) + WS( rs, 1 ) ] ) );
            ...
            }
            {
                ...
                Tv = LD( &( x[ WS( vs, 1 ) ] ), ms, &( x[ WS( vs, 1 ) ] ) );
                {
                    ...
                    Tp = LD( &( x[ WS( vs, 1 ) + WS( rs, 3 ) ] ), ms,
                             &( x[ WS( vs, 1 ) + WS( rs, 1 ) ] ) );
                    Tq = VSUB( To, Tp );
                    Tt = VADD( To, Tp );
                    Tl = LD( &( x[ WS( vs, 1 ) + WS( rs, 1 ) ] ), ms,
                             &( x[ WS( vs, 1 ) + WS( rs, 1 ) ] ) );
            ...
            }
            {
                ...
                TP = LD( &( x[ WS( vs, 2 ) ] ), ms, &( x[ WS( vs, 2 ) ] ) );
                {
                    ...
                    TJ = LD( &( x[ WS( vs, 2 ) + WS( rs, 3 ) ] ), ms,
                             &( x[ WS( vs, 2 ) + WS( rs, 1 ) ] ) );
                    TK = VSUB( TI, TJ );
                    TN = VADD( TI, TJ );
                    TF = LD( &( x[ WS( vs, 2 ) + WS( rs, 1 ) ] ), ms,
                             &( x[ WS( vs, 2 ) + WS( rs, 1 ) ] ) );
            ...
            }
            {
                ...
                T19 = LD( &( x[ WS( vs, 3 ) ] ), ms, &( x[ WS( vs, 3 ) ] ) );
                {
                    ...
                    T13 = LD( &( x[ WS( vs, 3 ) + WS( rs, 3 ) ] ), ms,
                              &( x[ WS( vs, 3 ) + WS( rs, 1 ) ] ) );
                    T14 = VSUB( T12, T13 );
                    T17 = VADD( T12, T13 );
                    TZ = LD( &( x[ WS( vs, 3 ) + WS( rs, 1 ) ] ), ms,
                             &( x[ WS( vs, 3 ) + WS( rs, 1 ) ] ) );
...
static const ct_desc desc = {5, XSIMD_STRING( "q1bv_5" ), twinstr, &GENUS, {85, 55, 15, 0}, 0, 0,
                             0};
