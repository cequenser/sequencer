...
/* Generated by: ../../../genfft/gen_twidsq_c.native -fma -simd -compact -variables 4
    ...
    DVK( KP707106781, +0.707106781186547524400844362104849039284835938 );
    {
              ...
              MAKE_VOLATILE_STRIDE( 16, vs ) )
        {
            ...
            }
            {
                ...
                {
                    V T1F, T1G, T1I, T1J;
                    T1F = LD( &( x[ WS( vs, 3 ) + WS( rs, 1 ) ] ), ms,
                              &( x[ WS( vs, 3 ) + WS( rs, 1 ) ] ) );
                    T1G = LD( &( x[ WS( vs, 3 ) + WS( rs, 5 ) ] ), ms,
                              &( x[ WS( vs, 3 ) + WS( rs, 1 ) ] ) );
                    T1H = VSUB( T1F, T1G );
                    T21 = VADD( T1F, T1G );
                    T1I = LD( &( x[ WS( vs, 3 ) + WS( rs, 7 ) ] ), ms,
                              &( x[ WS( vs, 3 ) + WS( rs, 1 ) ] ) );
                    T1J = LD( &( x[ WS( vs, 3 ) + WS( rs, 3 ) ] ), ms,
                              &( x[ WS( vs, 3 ) + WS( rs, 1 ) ] ) );
                    T1K = VSUB( T1I, T1J );
                    T22 = VADD( T1I, T1J );
                }
            ...
            }
            {
                ...
                {
                    V T2c, T2d, T2f, T2g;
                    T2c = LD( &( x[ WS( vs, 4 ) + WS( rs, 1 ) ] ), ms,
                              &( x[ WS( vs, 4 ) + WS( rs, 1 ) ] ) );
                    T2d = LD( &( x[ WS( vs, 4 ) + WS( rs, 5 ) ] ), ms,
                              &( x[ WS( vs, 4 ) + WS( rs, 1 ) ] ) );
                    T2e = VSUB( T2c, T2d );
                    T2y = VADD( T2c, T2d );
                    T2f = LD( &( x[ WS( vs, 4 ) + WS( rs, 7 ) ] ), ms,
                              &( x[ WS( vs, 4 ) + WS( rs, 1 ) ] ) );
                    T2g = LD( &( x[ WS( vs, 4 ) + WS( rs, 3 ) ] ), ms,
                              &( x[ WS( vs, 4 ) + WS( rs, 1 ) ] ) );
                    T2h = VSUB( T2f, T2g );
                    T2z = VADD( T2f, T2g );
                }
            ...
            }
            {
                ...
                {
                    V T3N, T3O, T3Q, T3R;
                    T3N = LD( &( x[ WS( vs, 7 ) + WS( rs, 1 ) ] ), ms,
                              &( x[ WS( vs, 7 ) + WS( rs, 1 ) ] ) );
                    T3O = LD( &( x[ WS( vs, 7 ) + WS( rs, 5 ) ] ), ms,
                              &( x[ WS( vs, 7 ) + WS( rs, 1 ) ] ) );
                    T3P = VSUB( T3N, T3O );
                    T49 = VADD( T3N, T3O );
                    T3Q = LD( &( x[ WS( vs, 7 ) + WS( rs, 7 ) ] ), ms,
                              &( x[ WS( vs, 7 ) + WS( rs, 1 ) ] ) );
                    T3R = LD( &( x[ WS( vs, 7 ) + WS( rs, 3 ) ] ), ms,
                              &( x[ WS( vs, 7 ) + WS( rs, 1 ) ] ) );
                    T3S = VSUB( T3Q, T3R );
                    T4a = VADD( T3Q, T3R );
                }
            ...
            }
            {
                ...
                {
                    V TB, TC, TE, TF;
                    TB = LD( &( x[ WS( vs, 1 ) + WS( rs, 1 ) ] ), ms,
                             &( x[ WS( vs, 1 ) + WS( rs, 1 ) ] ) );
                    TC = LD( &( x[ WS( vs, 1 ) + WS( rs, 5 ) ] ), ms,
                             &( x[ WS( vs, 1 ) + WS( rs, 1 ) ] ) );
                    TD = VSUB( TB, TC );
                    TX = VADD( TB, TC );
                    TE = LD( &( x[ WS( vs, 1 ) + WS( rs, 7 ) ] ), ms,
                             &( x[ WS( vs, 1 ) + WS( rs, 1 ) ] ) );
                    TF = LD( &( x[ WS( vs, 1 ) + WS( rs, 3 ) ] ), ms,
                             &( x[ WS( vs, 1 ) + WS( rs, 1 ) ] ) );
                    TG = VSUB( TE, TF );
                    TY = VADD( TE, TF );
                }
            ...
            }
            {
                ...
                {
                    V T18, T19, T1b, T1c;
                    T18 = LD( &( x[ WS( vs, 2 ) + WS( rs, 1 ) ] ), ms,
                              &( x[ WS( vs, 2 ) + WS( rs, 1 ) ] ) );
                    T19 = LD( &( x[ WS( vs, 2 ) + WS( rs, 5 ) ] ), ms,
                              &( x[ WS( vs, 2 ) + WS( rs, 1 ) ] ) );
                    T1a = VSUB( T18, T19 );
                    T1u = VADD( T18, T19 );
                    T1b = LD( &( x[ WS( vs, 2 ) + WS( rs, 7 ) ] ), ms,
                              &( x[ WS( vs, 2 ) + WS( rs, 1 ) ] ) );
                    T1c = LD( &( x[ WS( vs, 2 ) + WS( rs, 3 ) ] ), ms,
                              &( x[ WS( vs, 2 ) + WS( rs, 1 ) ] ) );
                    T1d = VSUB( T1b, T1c );
                    T1v = VADD( T1b, T1c );
                }
            ...
            }
            {
                ...
                {
                    V T2J, T2K, T2M, T2N;
                    T2J = LD( &( x[ WS( vs, 5 ) + WS( rs, 1 ) ] ), ms,
                              &( x[ WS( vs, 5 ) + WS( rs, 1 ) ] ) );
                    T2K = LD( &( x[ WS( vs, 5 ) + WS( rs, 5 ) ] ), ms,
                              &( x[ WS( vs, 5 ) + WS( rs, 1 ) ] ) );
                    T2L = VSUB( T2J, T2K );
                    T35 = VADD( T2J, T2K );
                    T2M = LD( &( x[ WS( vs, 5 ) + WS( rs, 7 ) ] ), ms,
                              &( x[ WS( vs, 5 ) + WS( rs, 1 ) ] ) );
                    T2N = LD( &( x[ WS( vs, 5 ) + WS( rs, 3 ) ] ), ms,
                              &( x[ WS( vs, 5 ) + WS( rs, 1 ) ] ) );
                    T2O = VSUB( T2M, T2N );
                    T36 = VADD( T2M, T2N );
                }
            ...
            }
            {
                ...
                {
                    V T3g, T3h, T3j, T3k;
                    T3g = LD( &( x[ WS( vs, 6 ) + WS( rs, 1 ) ] ), ms,
                              &( x[ WS( vs, 6 ) + WS( rs, 1 ) ] ) );
                    T3h = LD( &( x[ WS( vs, 6 ) + WS( rs, 5 ) ] ), ms,
                              &( x[ WS( vs, 6 ) + WS( rs, 1 ) ] ) );
                    T3i = VSUB( T3g, T3h );
                    T3C = VADD( T3g, T3h );
                    T3j = LD( &( x[ WS( vs, 6 ) + WS( rs, 7 ) ] ), ms,
                              &( x[ WS( vs, 6 ) + WS( rs, 1 ) ] ) );
                    T3k = LD( &( x[ WS( vs, 6 ) + WS( rs, 3 ) ] ), ms,
                              &( x[ WS( vs, 6 ) + WS( rs, 1 ) ] ) );
                    T3l = VSUB( T3j, T3k );
                    T3D = VADD( T3j, T3k );
                }
            ...
            }
            {
                ...
                ST( &( x[ WS( vs, 2 ) + WS( rs, 1 ) ] ), T11, ms,
                    &( x[ WS( vs, 2 ) + WS( rs, 1 ) ] ) );
                T25 = BYTW( &( W[ TWVL * 2 ] ), VFMAI( T23, T20 ) );
                ST( &( x[ WS( vs, 2 ) + WS( rs, 3 ) ] ), T25, ms,
                    &( x[ WS( vs, 2 ) + WS( rs, 1 ) ] ) );
                T39 = BYTW( &( W[ TWVL * 2 ] ), VFMAI( T37, T34 ) );
                ST( &( x[ WS( vs, 2 ) + WS( rs, 5 ) ] ), T39, ms,
                    &( x[ WS( vs, 2 ) + WS( rs, 1 ) ] ) );
                T4d = BYTW( &( W[ TWVL * 2 ] ), VFMAI( T4b, T48 ) );
                ST( &( x[ WS( vs, 2 ) + WS( rs, 7 ) ] ), T4d, ms,
                    &( x[ WS( vs, 2 ) + WS( rs, 1 ) ] ) );
            }
            {
                ...
                ST( &( x[ WS( vs, 4 ) + WS( rs, 5 ) ] ), T3c, ms,
                    &( x[ WS( vs, 4 ) + WS( rs, 1 ) ] ) );
                T4g = BYTW( &( W[ TWVL * 6 ] ), VSUB( T4e, T4f ) );
                ST( &( x[ WS( vs, 4 ) + WS( rs, 7 ) ] ), T4g, ms,
                    &( x[ WS( vs, 4 ) + WS( rs, 1 ) ] ) );
            ...
            }
            {
                ...
                ST( &( x[ WS( vs, 3 ) + WS( rs, 7 ) ] ), T40, ms,
                    &( x[ WS( vs, 3 ) + WS( rs, 1 ) ] ) );
                ST( &( x[ WS( vs, 5 ) + WS( rs, 7 ) ] ), T41, ms,
                    &( x[ WS( vs, 5 ) + WS( rs, 1 ) ] ) );
            }
            {
                V T2p, T2q, T2j, T2o;
            ...
            }
            {
                ...
                ST( &( x[ WS( vs, 3 ) + WS( rs, 3 ) ] ), T1S, ms,
                    &( x[ WS( vs, 3 ) + WS( rs, 1 ) ] ) );
                ST( &( x[ WS( vs, 5 ) + WS( rs, 3 ) ] ), T1T, ms,
                    &( x[ WS( vs, 5 ) + WS( rs, 1 ) ] ) );
            }
            {
                V TO, TP, TI, TN;
                ...
                ST( &( x[ WS( vs, 3 ) + WS( rs, 1 ) ] ), TO, ms,
                    &( x[ WS( vs, 3 ) + WS( rs, 1 ) ] ) );
                ST( &( x[ WS( vs, 5 ) + WS( rs, 1 ) ] ), TP, ms,
                    &( x[ WS( vs, 5 ) + WS( rs, 1 ) ] ) );
            }
            {
                V T1l, T1m, T1f, T1k;
            ...
            }
            {
                ...
                ST( &( x[ WS( vs, 3 ) + WS( rs, 5 ) ] ), T2W, ms,
                    &( x[ WS( vs, 3 ) + WS( rs, 1 ) ] ) );
                ST( &( x[ WS( vs, 5 ) + WS( rs, 5 ) ] ), T2X, ms,
                    &( x[ WS( vs, 5 ) + WS( rs, 1 ) ] ) );
            }
            {
                V T1p, T1q, T1n, T1o;
            ...
            }
            {
                ...
                ST( &( x[ WS( vs, 1 ) + WS( rs, 1 ) ] ), TS, ms,
                    &( x[ WS( vs, 1 ) + WS( rs, 1 ) ] ) );
                ST( &( x[ WS( vs, 7 ) + WS( rs, 1 ) ] ), TT, ms,
                    &( x[ WS( vs, 7 ) + WS( rs, 1 ) ] ) );
            }
            {
                V T1W, T1X, T1U, T1V;
                ...
                ST( &( x[ WS( vs, 1 ) + WS( rs, 3 ) ] ), T1W, ms,
                    &( x[ WS( vs, 1 ) + WS( rs, 1 ) ] ) );
                ST( &( x[ WS( vs, 7 ) + WS( rs, 3 ) ] ), T1X, ms,
                    &( x[ WS( vs, 7 ) + WS( rs, 1 ) ] ) );
            }
            {
                V T30, T31, T2Y, T2Z;
                ...
                ST( &( x[ WS( vs, 1 ) + WS( rs, 5 ) ] ), T30, ms,
                    &( x[ WS( vs, 1 ) + WS( rs, 1 ) ] ) );
                ST( &( x[ WS( vs, 7 ) + WS( rs, 5 ) ] ), T31, ms,
                    &( x[ WS( vs, 7 ) + WS( rs, 1 ) ] ) );
            }
            {
                V T44, T45, T42, T43;
                ...
                ST( &( x[ WS( vs, 1 ) + WS( rs, 7 ) ] ), T44, ms,
                    &( x[ WS( vs, 1 ) + WS( rs, 1 ) ] ) );
                ST( &( x[ WS( vs, 7 ) + WS( rs, 7 ) ] ), T45, ms,
                    &( x[ WS( vs, 7 ) + WS( rs, 1 ) ] ) );
            }
        }
    }
...
static const tw_instr twinstr[] = {VTW( 0, 1 ), VTW( 0, 2 ), VTW( 0, 3 ), VTW( 0, 4 ),
                                   VTW( 0, 5 ), VTW( 0, 6 ), VTW( 0, 7 ), {TW_NEXT, VL, 0}};

static const ct_desc desc = {8, XSIMD_STRING( "q1bv_8" ), twinstr, &GENUS, {184, 112, 80, 0}, 0, 0,
                             0};
...
/* Generated by: ../../../genfft/gen_twidsq_c.native -simd -compact -variables 4 -pipeline-latency 8
 * -n 8 -dif -name q1bv_8 -include dft/simd/q1b.h -sign 1 */
    ...
    DVK( KP707106781, +0.707106781186547524400844362104849039284835938 );
    {
              ...
              MAKE_VOLATILE_STRIDE( 16, vs ) )
        {
            ...
            }
            {
                ...
                {
                    V T1C, T1D, T1F, T1G;
                    T1C = LD( &( x[ WS( vs, 3 ) + WS( rs, 1 ) ] ), ms,
                              &( x[ WS( vs, 3 ) + WS( rs, 1 ) ] ) );
                    T1D = LD( &( x[ WS( vs, 3 ) + WS( rs, 5 ) ] ), ms,
                              &( x[ WS( vs, 3 ) + WS( rs, 1 ) ] ) );
                    T1E = VSUB( T1C, T1D );
                    T21 = VADD( T1C, T1D );
                    T1F = LD( &( x[ WS( vs, 3 ) + WS( rs, 7 ) ] ), ms,
                              &( x[ WS( vs, 3 ) + WS( rs, 1 ) ] ) );
                    T1G = LD( &( x[ WS( vs, 3 ) + WS( rs, 3 ) ] ), ms,
                              &( x[ WS( vs, 3 ) + WS( rs, 1 ) ] ) );
                    T1H = VSUB( T1F, T1G );
                    T22 = VADD( T1F, T1G );
                }
            ...
            }
            {
                ...
                {
                    V T29, T2a, T2c, T2d;
                    T29 = LD( &( x[ WS( vs, 4 ) + WS( rs, 1 ) ] ), ms,
                              &( x[ WS( vs, 4 ) + WS( rs, 1 ) ] ) );
                    T2a = LD( &( x[ WS( vs, 4 ) + WS( rs, 5 ) ] ), ms,
                              &( x[ WS( vs, 4 ) + WS( rs, 1 ) ] ) );
                    T2b = VSUB( T29, T2a );
                    T2y = VADD( T29, T2a );
                    T2c = LD( &( x[ WS( vs, 4 ) + WS( rs, 7 ) ] ), ms,
                              &( x[ WS( vs, 4 ) + WS( rs, 1 ) ] ) );
                    T2d = LD( &( x[ WS( vs, 4 ) + WS( rs, 3 ) ] ), ms,
                              &( x[ WS( vs, 4 ) + WS( rs, 1 ) ] ) );
                    T2e = VSUB( T2c, T2d );
                    T2z = VADD( T2c, T2d );
                }
            ...
            }
            {
                ...
                {
                    V T3K, T3L, T3N, T3O;
                    T3K = LD( &( x[ WS( vs, 7 ) + WS( rs, 1 ) ] ), ms,
                              &( x[ WS( vs, 7 ) + WS( rs, 1 ) ] ) );
                    T3L = LD( &( x[ WS( vs, 7 ) + WS( rs, 5 ) ] ), ms,
                              &( x[ WS( vs, 7 ) + WS( rs, 1 ) ] ) );
                    T3M = VSUB( T3K, T3L );
                    T49 = VADD( T3K, T3L );
                    T3N = LD( &( x[ WS( vs, 7 ) + WS( rs, 7 ) ] ), ms,
                              &( x[ WS( vs, 7 ) + WS( rs, 1 ) ] ) );
                    T3O = LD( &( x[ WS( vs, 7 ) + WS( rs, 3 ) ] ), ms,
                              &( x[ WS( vs, 7 ) + WS( rs, 1 ) ] ) );
                    T3P = VSUB( T3N, T3O );
                    T4a = VADD( T3N, T3O );
                }
            ...
            }
            {
                ...
                {
                    V Ty, Tz, TB, TC;
                    Ty = LD( &( x[ WS( vs, 1 ) + WS( rs, 1 ) ] ), ms,
                             &( x[ WS( vs, 1 ) + WS( rs, 1 ) ] ) );
                    Tz = LD( &( x[ WS( vs, 1 ) + WS( rs, 5 ) ] ), ms,
                             &( x[ WS( vs, 1 ) + WS( rs, 1 ) ] ) );
                    TA = VSUB( Ty, Tz );
                    TX = VADD( Ty, Tz );
                    TB = LD( &( x[ WS( vs, 1 ) + WS( rs, 7 ) ] ), ms,
                             &( x[ WS( vs, 1 ) + WS( rs, 1 ) ] ) );
                    TC = LD( &( x[ WS( vs, 1 ) + WS( rs, 3 ) ] ), ms,
                             &( x[ WS( vs, 1 ) + WS( rs, 1 ) ] ) );
                    TD = VSUB( TB, TC );
                    TY = VADD( TB, TC );
                }
            ...
            }
            {
                ...
                {
                    V T15, T16, T18, T19;
                    T15 = LD( &( x[ WS( vs, 2 ) + WS( rs, 1 ) ] ), ms,
                              &( x[ WS( vs, 2 ) + WS( rs, 1 ) ] ) );
                    T16 = LD( &( x[ WS( vs, 2 ) + WS( rs, 5 ) ] ), ms,
                              &( x[ WS( vs, 2 ) + WS( rs, 1 ) ] ) );
                    T17 = VSUB( T15, T16 );
                    T1u = VADD( T15, T16 );
                    T18 = LD( &( x[ WS( vs, 2 ) + WS( rs, 7 ) ] ), ms,
                              &( x[ WS( vs, 2 ) + WS( rs, 1 ) ] ) );
                    T19 = LD( &( x[ WS( vs, 2 ) + WS( rs, 3 ) ] ), ms,
                              &( x[ WS( vs, 2 ) + WS( rs, 1 ) ] ) );
                    T1a = VSUB( T18, T19 );
                    T1v = VADD( T18, T19 );
                }
            ...
            }
            {
                ...
                {
                    V T2G, T2H, T2J, T2K;
                    T2G = LD( &( x[ WS( vs, 5 ) + WS( rs, 1 ) ] ), ms,
                              &( x[ WS( vs, 5 ) + WS( rs, 1 ) ] ) );
                    T2H = LD( &( x[ WS( vs, 5 ) + WS( rs, 5 ) ] ), ms,
                              &( x[ WS( vs, 5 ) + WS( rs, 1 ) ] ) );
                    T2I = VSUB( T2G, T2H );
                    T35 = VADD( T2G, T2H );
                    T2J = LD( &( x[ WS( vs, 5 ) + WS( rs, 7 ) ] ), ms,
                              &( x[ WS( vs, 5 ) + WS( rs, 1 ) ] ) );
                    T2K = LD( &( x[ WS( vs, 5 ) + WS( rs, 3 ) ] ), ms,
                              &( x[ WS( vs, 5 ) + WS( rs, 1 ) ] ) );
                    T2L = VSUB( T2J, T2K );
                    T36 = VADD( T2J, T2K );
                }
            ...
            }
            {
                ...
                {
                    V T3d, T3e, T3g, T3h;
                    T3d = LD( &( x[ WS( vs, 6 ) + WS( rs, 1 ) ] ), ms,
                              &( x[ WS( vs, 6 ) + WS( rs, 1 ) ] ) );
                    T3e = LD( &( x[ WS( vs, 6 ) + WS( rs, 5 ) ] ), ms,
                              &( x[ WS( vs, 6 ) + WS( rs, 1 ) ] ) );
                    T3f = VSUB( T3d, T3e );
                    T3C = VADD( T3d, T3e );
                    T3g = LD( &( x[ WS( vs, 6 ) + WS( rs, 7 ) ] ), ms,
                              &( x[ WS( vs, 6 ) + WS( rs, 1 ) ] ) );
                    T3h = LD( &( x[ WS( vs, 6 ) + WS( rs, 3 ) ] ), ms,
                              &( x[ WS( vs, 6 ) + WS( rs, 1 ) ] ) );
                    T3i = VSUB( T3g, T3h );
                    T3D = VADD( T3g, T3h );
                }
...
static const ct_desc desc = {8, XSIMD_STRING( "q1bv_8" ), twinstr, &GENUS, {264, 128, 0, 0}, 0, 0,
                             0};
