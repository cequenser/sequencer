 ...
 * -pipeline-latency 8 -n 10 -name t1buv_10 -include dft/simd/t1bu.h -sign 1 */
...
static const tw_instr twinstr[] = {VTW( 0, 1 ), VTW( 0, 2 ),     VTW( 0, 3 ), VTW( 0, 4 ),
                                   ...
                                   VTW( 0, 9 ), {TW_NEXT, VL, 0}};

static const ct_desc desc = {10, XSIMD_STRING( "t1buv_10" ), twinstr, &GENUS, {33, 22, 18, 0}, 0, 0,
                             0};
 ...
 * 8 -n 10 -name t1buv_10 -include dft/simd/t1bu.h -sign 1 */
...
static const ct_desc desc = {10, XSIMD_STRING( "t1buv_10" ), twinstr, &GENUS, {45, 24, 6, 0}, 0, 0,
                             0};
