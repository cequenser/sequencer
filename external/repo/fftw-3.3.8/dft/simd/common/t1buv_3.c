 ...
 * -pipeline-latency 8 -n 3 -name t1buv_3 -include dft/simd/t1bu.h -sign 1 */
...
static void t1buv_3( R* ri, R* ii, const R* W, stride rs, INT mb, INT me, INT ms )
{
    ...
    DVK( KP500000000, +0.500000000000000000000000000000000000000000000 );
    {
        ...
        for ( m = mb, W = W + ( mb * ( ( TWVL / VL ) * 4 ) ); m < me;
              m = m + VL, x = x + ( VL * ms ), W = W + ( TWVL * 4 ), MAKE_VOLATILE_STRIDE( 3, rs ) )
        {
 ...
 * 8 -n 3 -name t1buv_3 -include dft/simd/t1bu.h -sign 1 */
