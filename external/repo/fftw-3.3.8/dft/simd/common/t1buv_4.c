 ...
 * -pipeline-latency 8 -n 4 -name t1buv_4 -include dft/simd/t1bu.h -sign 1 */
...
{
    {
        ...
        for ( m = mb, W = W + ( mb * ( ( TWVL / VL ) * 6 ) ); m < me;
              m = m + VL, x = x + ( VL * ms ), W = W + ( TWVL * 6 ), MAKE_VOLATILE_STRIDE( 4, rs ) )
        {
 ...
 * 8 -n 4 -name t1buv_4 -include dft/simd/t1bu.h -sign 1 */
