 ...
 * -pipeline-latency 8 -n 5 -name t1buv_5 -include dft/simd/t1bu.h -sign 1 */
...
static void t1buv_5( R* ri, R* ii, const R* W, stride rs, INT mb, INT me, INT ms )
{
    ...
    DVK( KP951056516, +0.951056516295153572116439333379382143405698634 );
    {
        ...
        R* x;
        x = ii;
        for ( m = mb, W = W + ( mb * ( ( TWVL / VL ) * 8 ) ); m < me;
              m = m + VL, x = x + ( VL * ms ), W = W + ( TWVL * 8 ), MAKE_VOLATILE_STRIDE( 5, rs ) )
        {
            V T1, Tg, Th, T6, Tb, Tc;
            T1 = LD( &( x[ 0 ] ), ms, &( x[ 0 ] ) );
            {
...
static const ct_desc desc = {5, XSIMD_STRING( "t1buv_5" ), twinstr, &GENUS, {11, 10, 9, 0}, 0, 0,
                             0};
 ...
 * 8 -n 5 -name t1buv_5 -include dft/simd/t1bu.h -sign 1 */
...
static const ct_desc desc = {5, XSIMD_STRING( "t1buv_5" ), twinstr, &GENUS, {17, 11, 3, 0}, 0, 0,
                             0};
