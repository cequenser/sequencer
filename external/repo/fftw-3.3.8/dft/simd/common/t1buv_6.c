 ...
 * -pipeline-latency 8 -n 6 -name t1buv_6 -include dft/simd/t1bu.h -sign 1 */
...
static const ct_desc desc = {6, XSIMD_STRING( "t1buv_6" ), twinstr, &GENUS, {17, 12, 6, 0}, 0, 0,
                             0};
 ...
 * 8 -n 6 -name t1buv_6 -include dft/simd/t1bu.h -sign 1 */
...
static const ct_desc desc = {6, XSIMD_STRING( "t1buv_6" ), twinstr, &GENUS, {21, 12, 2, 0}, 0, 0,
                             0};
