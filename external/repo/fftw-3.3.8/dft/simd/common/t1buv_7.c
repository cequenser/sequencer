 ...
 * -pipeline-latency 8 -n 7 -name t1buv_7 -include dft/simd/t1bu.h -sign 1 */
...
static const tw_instr twinstr[] = {VTW( 0, 1 ), VTW( 0, 2 ), VTW( 0, 3 ),     VTW( 0, 4 ),
                                   VTW( 0, 5 ), VTW( 0, 6 ), {TW_NEXT, VL, 0}};

static const ct_desc desc = {7, XSIMD_STRING( "t1buv_7" ), twinstr, &GENUS, {15, 15, 21, 0}, 0, 0,
                             0};
 ...
 * 8 -n 7 -name t1buv_7 -include dft/simd/t1bu.h -sign 1 */
...
static const ct_desc desc = {7, XSIMD_STRING( "t1buv_7" ), twinstr, &GENUS, {24, 18, 12, 0}, 0, 0,
                             0};
