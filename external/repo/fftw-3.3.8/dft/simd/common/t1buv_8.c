 ...
 * -pipeline-latency 8 -n 8 -name t1buv_8 -include dft/simd/t1bu.h -sign 1 */
...
static const ct_desc desc = {8, XSIMD_STRING( "t1buv_8" ), twinstr, &GENUS, {23, 14, 10, 0}, 0, 0,
                             0};
 ...
 * 8 -n 8 -name t1buv_8 -include dft/simd/t1bu.h -sign 1 */
...
static const ct_desc desc = {8, XSIMD_STRING( "t1buv_8" ), twinstr, &GENUS, {33, 16, 0, 0}, 0, 0,
                             0};
