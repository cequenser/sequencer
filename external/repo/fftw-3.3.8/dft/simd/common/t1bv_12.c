 ...
 * -pipeline-latency 8 -n 12 -name t1bv_12 -include dft/simd/t1b.h -sign 1 */
...
static const tw_instr twinstr[] = {VTW( 0, 1 ), VTW( 0, 2 ),  VTW( 0, 3 ),  VTW( 0, 4 ),
                                   ...
                                   VTW( 0, 9 ), VTW( 0, 10 ), VTW( 0, 11 ), {TW_NEXT, VL, 0}};

static const ct_desc desc = {12, XSIMD_STRING( "t1bv_12" ), twinstr, &GENUS, {41, 24, 18, 0}, 0, 0,
                             0};
 ...
 * 8 -n 12 -name t1bv_12 -include dft/simd/t1b.h -sign 1 */
...
static const ct_desc desc = {12, XSIMD_STRING( "t1bv_12" ), twinstr, &GENUS, {55, 26, 4, 0}, 0, 0,
                             0};
