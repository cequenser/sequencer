 ...
 * -pipeline-latency 8 -n 15 -name t1bv_15 -include dft/simd/t1b.h -sign 1 */
...
static const tw_instr twinstr[] = {VTW( 0, 1 ),  VTW( 0, 2 ),  VTW( 0, 3 ),     VTW( 0, 4 ),
                                   ...
                                   VTW( 0, 13 ), VTW( 0, 14 ), {TW_NEXT, VL, 0}};

static const ct_desc desc = {15, XSIMD_STRING( "t1bv_15" ), twinstr, &GENUS, {50, 35, 42, 0}, 0, 0,
                             0};
 ...
 * 8 -n 15 -name t1bv_15 -include dft/simd/t1b.h -sign 1 */
...
static const ct_desc desc = {15, XSIMD_STRING( "t1bv_15" ), twinstr, &GENUS, {78, 39, 14, 0}, 0, 0,
                             0};
