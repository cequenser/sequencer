 ...
 * -pipeline-latency 8 -n 25 -name t1bv_25 -include dft/simd/t1b.h -sign 1 */
...
static const ct_desc desc = {25, XSIMD_STRING( "t1bv_25" ), twinstr, &GENUS, {67, 60, 181, 0}, 0, 0,
                             0};
 ...
 * 8 -n 25 -name t1bv_25 -include dft/simd/t1b.h -sign 1 */
    ...
    DVK( KP559016994, +0.559016994374947424102293417182819058860154590 );
    {
              ...
              x = x + ( VL * ms ), W = W + ( TWVL * 48 ), MAKE_VOLATILE_STRIDE( 25, rs ) )
        {
            ...
            }
            {
                ...
                T38 = VBYI(
                    VSUB( VFMA( LDK( KP951056516 ), VSUB( T2U, T2V ),
