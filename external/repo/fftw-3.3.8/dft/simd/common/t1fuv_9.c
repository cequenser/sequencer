 ...
 * -pipeline-latency 8 -n 9 -name t1fuv_9 -include dft/simd/t1fu.h */
...
static const ct_desc desc = {9, XSIMD_STRING( "t1fuv_9" ), twinstr, &GENUS, {20, 20, 34, 0}, 0, 0,
                             0};
 ...
 * 8 -n 9 -name t1fuv_9 -include dft/simd/t1fu.h */
            ...
            }
            {
                ...
                TH = VFMA(
                    ...
                    VFNMS( LDK( KP296198132 ), Tw,
                           VFNMS( LDK( KP939692620 ), Tv, VFNMS( LDK( KP852868531 ), Tt, Tr ) ) ) );
...
static const ct_desc desc = {9, XSIMD_STRING( "t1fuv_9" ), twinstr, &GENUS, {38, 26, 16, 0}, 0, 0,
                             0};
