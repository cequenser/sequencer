            ...
            }
            {
                ...
                }
                {
                    ...
                    ST( &( ri[ WS( rs, 10 ) ] ), VFNMS( LDK( KP707106781 ), T39, T2Y ), ms,
                        &( ri[ 0 ] ) );
                    ST( &( ri[ WS( rs, 2 ) ] ), VFMA( LDK( KP707106781 ), T39, T2Y ), ms,
                        &( ri[ 0 ] ) );
                    T3w = VADD( T3b, T3c );
                    ST( &( ii[ WS( rs, 2 ) ] ), VFMA( LDK( KP707106781 ), T3w, T3v ), ms,
                        &( ii[ 0 ] ) );
                    ...
                    ST( &( ri[ WS( rs, 14 ) ] ), VFNMS( LDK( KP707106781 ), T3d, T3a ), ms,
                        &( ri[ 0 ] ) );
                    ST( &( ri[ WS( rs, 6 ) ] ), VFMA( LDK( KP707106781 ), T3d, T3a ), ms,
                        &( ri[ 0 ] ) );
                    T3y = VSUB( T38, T33 );
                    ST( &( ii[ WS( rs, 6 ) ] ), VFMA( LDK( KP707106781 ), T3y, T3x ), ms,
                        &( ii[ 0 ] ) );
...
static const ct_desc desc = {16, XSIMD_STRING( "t1sv_16" ), twinstr, &GENUS, {104, 30, 70, 0}, 0, 0,
                             0};
 ...
 * -n 16 -name t1sv_16 -include dft/simd/ts.h */
...
static const ct_desc desc = {16, XSIMD_STRING( "t1sv_16" ), twinstr, &GENUS, {136, 46, 38, 0}, 0, 0,
                             0};
