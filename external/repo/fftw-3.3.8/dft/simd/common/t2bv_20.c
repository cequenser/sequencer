 ...
 * -pipeline-latency 8 -n 20 -name t2bv_20 -include dft/simd/t2b.h -sign 1 */
...
static const tw_instr twinstr[] = {VTW( 0, 1 ),  VTW( 0, 2 ),  VTW( 0, 3 ),  VTW( 0, 4 ),
                                   ...
                                   VTW( 0, 17 ), VTW( 0, 18 ), VTW( 0, 19 ), {TW_NEXT, VL, 0}};

static const ct_desc desc = {20, XSIMD_STRING( "t2bv_20" ), twinstr, &GENUS, {77, 42, 46, 0}, 0, 0,
                             0};
 ...
 * 8 -n 20 -name t2bv_20 -include dft/simd/t2b.h -sign 1 */
...
static const ct_desc desc = {20, XSIMD_STRING( "t2bv_20" ), twinstr, &GENUS, {111, 50, 12, 0}, 0, 0,
                             0};
