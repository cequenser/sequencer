 ...
 * -pipeline-latency 8 -n 25 -name t2fv_25 -include dft/simd/t2f.h */
...
static const ct_desc desc = {25, XSIMD_STRING( "t2fv_25" ), twinstr, &GENUS, {67, 60, 181, 0}, 0, 0,
                             0};
 ...
 * 8 -n 25 -name t2fv_25 -include dft/simd/t2f.h */
              ...
              x = x + ( VL * ms ), W = W + ( TWVL * 48 ), MAKE_VOLATILE_STRIDE( 25, rs ) )
        {
            ...
            }
            {
                ...
                ST( &( x[ WS( rs, 8 ) ] ), VADD( T2E, T2F ), ms, &( x[ 0 ] ) );
                {
                    ...
                    T2V =
                        VBYI( VADD( T2M, VADD( T2O, VFNMS( LDK( KP587785252 ), T2U,
                                                           VMUL( LDK( KP951056516 ), T2R ) ) ) ) );
                    T34 = VBYI( VADD(
                        T2O, VSUB( VFMA( LDK( KP587785252 ), T2R, VMUL( LDK( KP951056516 ), T2U ) ),
                                   T2M ) ) );
