 ...
 * -pipeline-latency 8 -twiddle-log3 -precompute-twiddles -no-generate-bytw -n 10 -name t3bv_10
...
static const ct_desc desc = {10, XSIMD_STRING( "t3bv_10" ), twinstr, &GENUS, {39, 34, 18, 0}, 0, 0,
                             0};
 ...
 * 8 -twiddle-log3 -precompute-twiddles -no-generate-bytw -n 10 -name t3bv_10 -include
...
static const ct_desc desc = {10, XSIMD_STRING( "t3bv_10" ), twinstr, &GENUS, {51, 36, 6, 0}, 0, 0,
                             0};
