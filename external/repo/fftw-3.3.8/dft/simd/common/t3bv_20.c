 ...
 * -pipeline-latency 8 -twiddle-log3 -precompute-twiddles -no-generate-bytw -n 20 -name t3bv_20
...
static const ct_desc desc = {20, XSIMD_STRING( "t3bv_20" ), twinstr, &GENUS, {92, 72, 46, 0}, 0, 0,
                             0};
 ...
 * 8 -twiddle-log3 -precompute-twiddles -no-generate-bytw -n 20 -name t3bv_20 -include
...
static const ct_desc desc = {20, XSIMD_STRING( "t3bv_20" ), twinstr, &GENUS, {126, 80, 12, 0}, 0, 0,
                             0};
