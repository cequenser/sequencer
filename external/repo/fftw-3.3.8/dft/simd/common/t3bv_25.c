 ...
 * -pipeline-latency 8 -twiddle-log3 -precompute-twiddles -no-generate-bytw -n 25 -name t3bv_25
 ...
 * 8 -twiddle-log3 -precompute-twiddles -no-generate-bytw -n 25 -name t3bv_25 -include
            ...
            T11 = VZMULJ( TB, T4 );
            {
                ...
                }
                {
                    V T3E, T3M, T3I, T3J, T3H, T3K, T3N, T3L;
                    {
                        ...
                        T3D = VSUB( T3B, T3C );
                        T3E = VBYI(
                            VFMA( LDK( KP951056516 ), T3A, VMUL( LDK( KP587785252 ), T3D ) ) );
                        T3M = VBYI(
                            VFNMS( LDK( KP951056516 ), T3D, VMUL( LDK( KP587785252 ), T3A ) ) );
                        T3I = VADD( T1Y, T1Z );
                        T3F = VADD( T3y, T3z );
                        T3G = VADD( T3B, T3C );
                        T3J = VADD( T3F, T3G );
