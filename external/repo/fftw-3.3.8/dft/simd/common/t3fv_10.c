 ...
 * -pipeline-latency 8 -twiddle-log3 -precompute-twiddles -no-generate-bytw -n 10 -name t3fv_10
...
static const tw_instr twinstr[] = {VTW( 0, 1 ), VTW( 0, 3 ), VTW( 0, 9 ), {TW_NEXT, VL, 0}};

static const ct_desc desc = {10, XSIMD_STRING( "t3fv_10" ), twinstr, &GENUS, {39, 34, 18, 0}, 0, 0,
                             0};
 ...
 * 8 -twiddle-log3 -precompute-twiddles -no-generate-bytw -n 10 -name t3fv_10 -include
 * dft/simd/t3f.h */
...
static const ct_desc desc = {10, XSIMD_STRING( "t3fv_10" ), twinstr, &GENUS, {51, 36, 6, 0}, 0, 0,
                             0};
