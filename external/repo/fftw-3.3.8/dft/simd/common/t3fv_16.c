 ...
 * -pipeline-latency 8 -twiddle-log3 -precompute-twiddles -no-generate-bytw -n 16 -name t3fv_16
...
static const ct_desc desc = {16, XSIMD_STRING( "t3fv_16" ), twinstr, &GENUS, {64, 52, 34, 0}, 0, 0,
                             0};
 ...
 * 8 -twiddle-log3 -precompute-twiddles -no-generate-bytw -n 16 -name t3fv_16 -include
 * dft/simd/t3f.h */
...
static const ct_desc desc = {16, XSIMD_STRING( "t3fv_16" ), twinstr, &GENUS, {94, 60, 4, 0}, 0, 0,
                             0};
