 ...
 * -pipeline-latency 8 -twiddle-log3 -precompute-twiddles -no-generate-bytw -n 25 -name t3fv_25
 ...
 * 8 -twiddle-log3 -precompute-twiddles -no-generate-bytw -n 25 -name t3fv_25 -include
 * dft/simd/t3f.h */
            ...
            TU = VZMULJ( Td, T8 );
            {
                ...
                }
                {
                    V T3J, T3K, T3D, T3E, T3C, T3F, T3L, T3G;
                    {
                        ...
                        T3I = VSUB( T3z, T3A );
                        T3J = VBYI(
                            VFMA( LDK( KP951056516 ), T3H, VMUL( LDK( KP587785252 ), T3I ) ) );
                        T3K = VBYI(
                            VFNMS( LDK( KP587785252 ), T3H, VMUL( LDK( KP951056516 ), T3I ) ) );
                        T3D = VADD( Tl, Tm );
                        T3y = VADD( T3w, T3x );
                        T3B = VADD( T3z, T3A );
                        T3E = VADD( T3y, T3B );
                ...
                }
                {
                    ...
                    T2B = VBYI(
                        VADD( T22, VFMA( LDK( KP309016994 ), T2w,
                ...
                }
                {
                    ...
                    ST( &( x[ WS( rs, 8 ) ] ), VADD( T32, T33 ), ms, &( x[ 0 ] ) );
                    {
                        ...
                        T3j = VBYI(
                            VADD( T3a, VADD( T3c, VFNMS( LDK( KP587785252 ), T3i,
