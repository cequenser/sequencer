 ...
 * -pipeline-latency 8 -twiddle-log3 -precompute-twiddles -no-generate-bytw -n 8 -name t3fv_8
...
static const ct_desc desc = {8, XSIMD_STRING( "t3fv_8" ), twinstr, &GENUS, {27, 22, 10, 0}, 0, 0,
                             0};
 ...
 * 8 -twiddle-log3 -precompute-twiddles -no-generate-bytw -n 8 -name t3fv_8 -include dft/simd/t3f.h
 */
