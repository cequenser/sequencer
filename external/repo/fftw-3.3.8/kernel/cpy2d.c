    ...
    case 2:
             ...
             ( ( is1 & 1 ) == 0 ) && ( ( os0 & 1 ) == 0 ) && ( ( os1 & 1 ) == 0 ) )
        {
            ...
            for ( i1 = 0; i1 < n1; ++i1 )
                for ( i0 = 0; i0 < n0; ++i0 )
                {
                    *(WIDE_TYPE*)&O[ i0 * os0 + i1 * os1 ] = *(WIDE_TYPE*)&I[ i0 * is0 + i1 * is1 ];
                }
        }
...
static void dotile( INT n0l, INT n0u, INT n1l, INT n1u, void* args )
{
    ...
    X( cpy2d )
    ( k->I + n0l * k->is0 + n1l * k->is1, k->O + n0l * k->os0 + n1l * k->os1, n0u - n0l, k->is0,
      k->os0, n1u - n1l, k->is1, k->os1, k->vl );
}
...
static void dotile_buf( INT n0l, INT n0u, INT n1l, INT n1u, void* args )
{
    ...
    /* copy from I to buf */
    X( cpy2d_ci )
    ( k->I + n0l * k->is0 + n1l * k->is1, k->buf, n0u - n0l, k->is0, k->vl, n1u - n1l, k->is1,
      k->vl * ( n0u - n0l ), k->vl );

    /* copy from buf to O */
    X( cpy2d_co )
    ( k->buf, k->O + n0l * k->os0 + n1l * k->os1, n0u - n0l, k->vl, k->os0, n1u - n1l,
      k->vl * ( n0u - n0l ), k->os1, k->vl );
}
...
void X( cpy2d_tiledbuf )( R* I, R* O, INT n0, INT is0, INT os0, INT n1, INT is1, INT os1, INT vl )
{
