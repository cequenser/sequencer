...
/* define HAVE_SIMD if any simd extensions are supported */
    ...
    defined( HAVE_MIPS_PS ) || defined( HAVE_GENERIC_SIMD128 ) || defined( HAVE_GENERIC_SIMD256 )
#define HAVE_SIMD 1
#else
#define HAVE_SIMD 0
#endif
...
#define FFTW_2R_IS_DOUBLE                                                                          \
    ( defined( FFTW_SINGLE ) && SIZEOF_FLOAT != 0 && SIZEOF_DOUBLE == 2 * SIZEOF_FLOAT )

#define DOUBLE_ALIGNED( p ) ( ( ( ( uintptr_t )( p ) ) % sizeof( double ) ) == 0 )

    /*-----------------------------------------------------------------------*/
    /* assert.c: */
    IFFTW_EXTERN void X( assertion_failed )( const char* s, int line, const char* file );
...
#define FINITE_RNK( rnk ) ( ( rnk ) != RNK_MINFTY )
    ...
    tensor* X( mktensor_3d )( INT n0, INT is0, INT os0, INT n1, INT is1, INT os1, INT n2, INT is2,
                              INT os2 );
    tensor* X( mktensor_4d )( INT n0, INT is0, INT os0, INT n1, INT is1, INT os1, INT n2, INT is2,
                              INT os2, INT n3, INT is3, INT os3 );
    tensor* X( mktensor_5d )( INT n0, INT is0, INT os0, INT n1, INT is1, INT os1, INT n2, INT is2,
                              INT os2, INT n3, INT is3, INT os3, INT n4, INT is4, INT os4 );
    ...
    int X( tensor_strides_decrease )( const tensor* sz, const tensor* vecsz, inplace_kind k );
...
#define NO_NONTHREADEDP( plnr ) ( ( PLNR_L( plnr ) & NO_NONTHREADED ) && ( plnr )->nthr > 1 )
...
#define NO_BUFFERINGP( plnr ) ( PLNR_L( plnr ) & NO_BUFFERING )
    ...
    struct planner_s
    {
        ...
        void ( *hook )( struct planner_s* plnr, plan* pln, const problem* p, int optimalp );
...
#define SOLVTAB_END                                                                                \
    ...
    /*-----------------------------------------------------------------------*/
    /* pickdim.c */
    int X( pickdim )( int which_dim, const int* buddies, size_t nbuddies, const tensor* sz, int oop,
                      int* dp );
    ...
    void X( twiddle_awake )( enum wakefulness wakefulness, twid** pp, const tw_instr* instr, INT n,
                             INT r, INT m );
...
#define CACHESIZE 8192
    ...
    void X( tile2d )( INT n0l, INT n0u, INT n1l, INT n1u, INT tilesz,
                      void ( *f )( INT n0l, INT n0u, INT n1l, INT n1u, void* args ), void* args );
    void X( cpy1d )( R* I, R* O, INT n0, INT is0, INT os0, INT vl );
    void X( zero1d_pair )( R* O0, R* O1, INT n0, INT os0 );
    void X( cpy2d )( R* I, R* O, INT n0, INT is0, INT os0, INT n1, INT is1, INT os1, INT vl );
    void X( cpy2d_ci )( R* I, R* O, INT n0, INT is0, INT os0, INT n1, INT is1, INT os1, INT vl );
    void X( cpy2d_co )( R* I, R* O, INT n0, INT is0, INT os0, INT n1, INT is1, INT os1, INT vl );
    void X( cpy2d_tiled )( R* I, R* O, INT n0, INT is0, INT os0, INT n1, INT is1, INT os1, INT vl );
    void X( cpy2d_tiledbuf )( R* I, R* O, INT n0, INT is0, INT os0, INT n1, INT is1, INT os1,
                              INT vl );
    void X( cpy2d_pair )( R* I0, R* I1, R* O0, R* O1, INT n0, INT is0, INT os0, INT n1, INT is1,
                          INT os1 );
    void X( cpy2d_pair_ci )( R* I0, R* I1, R* O0, R* O1, INT n0, INT is0, INT os0, INT n1, INT is1,
                             INT os1 );
    void X( cpy2d_pair_co )( R* I0, R* I1, R* O0, R* O1, INT n0, INT is0, INT os0, INT n1, INT is1,
                             INT os1 );
    ...
    typedef void ( *cpy2d_func )( R* I, R* O, INT n0, INT is0, INT os0, INT n1, INT is1, INT os1,
                                  INT vl );
    ...
    double X( measure_execution_time )( const planner* plnr, plan* pln, const problem* p );
    IFFTW_EXTERN int X( ialignment_of )( R* p );
    unsigned X( hash )( const char* s );
    INT X( nbuf )( INT n, INT vl, INT maxnbuf );
    int X( nbuf_redundant )( INT n, INT vl, size_t which, const INT* maxnbuf, size_t nmaxnbuf );
