...
#define HI( x ) ( ( x ) >> SHFT )
#define HI_SIGNED( x ) ( ( ( ( x ) + ( ACC )( RADIX >> 1 ) * RADIX ) >> SHFT ) - ( RADIX >> 1 ) )
...
static const N i31fac = {
    {1, -7, {28087, 45433, 51357, 24545, 14291, 3954, 57879, 8109, 38716, 41382}}};

/* 1 / 32! */
static const N i32fac = {
    {1, -7, {52078, 60811, 3652, 39679, 37310, 47227, 28432, 57597, 13497, 1293}}};
...
void fftaccuracy( int n, bench_complex* a, bench_complex* ffta, int sign, double err[ 6 ] )
{
