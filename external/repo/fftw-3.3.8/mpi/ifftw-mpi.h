...
void XM( block_coords )( const dtensor* sz, block_kind k, int which_pe, INT* coords );
...
int XM( rearrange_applicable )( rearrangement rearrange, ddim dim0, INT vn, int n_pes );
