...
problem* XM( mkproblem_rdft2 )( const dtensor* sz, INT vn, R* I, R* O, MPI_Comm comm,
                                rdft_kind kind, unsigned flags );
problem* XM( mkproblem_rdft2_d )( dtensor* sz, INT vn, R* I, R* O, MPI_Comm comm, rdft_kind kind,
                                  unsigned flags );
...
#define MKPLAN_MPI_RDFT2( type, adt, apply ) (type*)X( mkplan_rdft )( sizeof( type ), adt, apply )
