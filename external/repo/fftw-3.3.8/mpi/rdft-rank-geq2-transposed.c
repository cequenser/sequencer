...
static int applicable( const S* ego, const problem* p_, const planner* plnr )
{
    ...
    return ( 1 && p->sz->rnk > 1 && p->flags == TRANSPOSED_OUT &&
...
static plan* mkplan( const solver* ego_, const problem* p_, planner* plnr )
{
        ...
        nrest *= sz->dims[ i ].n;
    {
        ...
        cld1 = X( mkplan_d )( plnr,
                              X( mkproblem_rdft_d )( sz, X( mktensor_2d )( b, is, is, p->vn, 1, 1 ),
                                                     I2, I, p->kind + 1 ) );
    ...
    nrest *= p->vn;
    cldt = X( mkplan_d )( plnr, XM( mkproblem_transpose )( p->sz->dims[ 0 ].n, p->sz->dims[ 1 ].n,
...

    {
        ...
        cld2 = X( mkplan_d )(
            plnr, X( mkproblem_rdft_1_d )( X( mktensor_1d )( p->sz->dims[ 0 ].n, nrest, nrest ),
