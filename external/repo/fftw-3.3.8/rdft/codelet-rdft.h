...
typedef void ( *kr2c )( R* R0, R* R1, R* Cr, R* Ci, stride rs, stride csr, stride csi, INT vl,
                        INT ivs, INT ovs );
...
typedef void ( *khc2hc )( R* rioarray, R* iioarray, const R* W, stride rs, INT mb, INT me, INT ms );
...
typedef struct
{
    int ( *okp )( const R* Rp, const R* Ip, const R* Rm, const R* Im, INT rs, INT mb, INT me,
                  INT ms, const planner* plnr );
    rdft_kind kind;
    INT vl;
} hc2c_genus;
...
typedef void ( *khc2c )( R* Rp, R* Ip, R* Rm, R* Im, const R* W, stride rs, INT mb, INT me,
                         INT ms );
void X( khc2c_register )( planner* p, khc2c codelet, const hc2c_desc* desc, hc2c_kind hc2ckind );
...
typedef void ( *kr2r )( const R* I, R* O, stride is, stride os, INT vl, INT ivs, INT ovs );
