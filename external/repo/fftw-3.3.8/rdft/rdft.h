...
#define MKPLAN_RDFT( type, adt, apply ) (type*)X( mkplan_rdft )( sizeof( type ), adt, apply )
    ...
    */
    ...
    problem* X( mkproblem_rdft2 )( const tensor* sz, const tensor* vecsz, R* r0, R* r1, R* cr,
                                   R* ci, rdft_kind kind );
    problem* X( mkproblem_rdft2_d )( tensor* sz, tensor* vecsz, R* r0, R* r1, R* cr, R* ci,
                                     rdft_kind kind );
    problem* X( mkproblem_rdft2_d_3pointers )( tensor* sz, tensor* vecsz, R* r, R* cr, R* ci,
                                               rdft_kind kind );
...
#define MKPLAN_RDFT2( type, adt, apply ) (type*)X( mkplan_rdft2 )( sizeof( type ), adt, apply )
