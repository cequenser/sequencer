 ...
 * -sign 1 -twiddle-log3 -precompute-twiddles -n 20 -dif -name hb2_20 -include rdft/scalar/hb.h */
...
static void hb2_20( R* cr, R* ci, const R* W, stride rs, INT mb, INT me, INT ms )
{
    ...
    DK( KP618033988, +0.618033988749894848204586834365638117720309180 );
    {
        ...
        for ( m = mb, W = W + ( ( mb - 1 ) * 8 ); m < me;
              m = m + 1, cr = cr + ms, ci = ci - ms, W = W + 8, MAKE_VOLATILE_STRIDE( 40, rs ) )
        {
 ...
 * -twiddle-log3 -precompute-twiddles -n 20 -dif -name hb2_20 -include rdft/scalar/hb.h */
