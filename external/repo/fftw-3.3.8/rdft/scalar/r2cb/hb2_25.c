 ...
 * -sign 1 -twiddle-log3 -precompute-twiddles -n 25 -dif -name hb2_25 -include rdft/scalar/hb.h */
...
static void hb2_25( R* cr, R* ci, const R* W, stride rs, INT mb, INT me, INT ms )
{
    ...
    DK( KP618033988, +0.618033988749894848204586834365638117720309180 );
    {
        ...
        for ( m = mb, W = W + ( ( mb - 1 ) * 8 ); m < me;
              m = m + 1, cr = cr + ms, ci = ci - ms, W = W + 8, MAKE_VOLATILE_STRIDE( 50, rs ) )
        {
...
static const tw_instr twinstr[] = {
    {TW_CEXP, 1, 1}, {TW_CEXP, 1, 3}, {TW_CEXP, 1, 9}, {TW_CEXP, 1, 24}, {TW_NEXT, 1, 0}};
 ...
 * -twiddle-log3 -precompute-twiddles -n 25 -dif -name hb2_25 -include rdft/scalar/hb.h */
