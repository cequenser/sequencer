 ...
 * -sign 1 -twiddle-log3 -precompute-twiddles -n 4 -dif -name hb2_4 -include rdft/scalar/hb.h */
...
{
    {
        ...
        for ( m = mb, W = W + ( ( mb - 1 ) * 4 ); m < me;
              m = m + 1, cr = cr + ms, ci = ci - ms, W = W + 4, MAKE_VOLATILE_STRIDE( 8, rs ) )
        {
 ...
 * -twiddle-log3 -precompute-twiddles -n 4 -dif -name hb2_4 -include rdft/scalar/hb.h */
