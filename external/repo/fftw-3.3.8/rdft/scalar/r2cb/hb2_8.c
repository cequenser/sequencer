 ...
 * -sign 1 -twiddle-log3 -precompute-twiddles -n 8 -dif -name hb2_8 -include rdft/scalar/hb.h */
...
static void hb2_8( R* cr, R* ci, const R* W, stride rs, INT mb, INT me, INT ms )
{
    DK( KP707106781, +0.707106781186547524400844362104849039284835938 );
    {
        ...
        for ( m = mb, W = W + ( ( mb - 1 ) * 6 ); m < me;
              m = m + 1, cr = cr + ms, ci = ci - ms, W = W + 6, MAKE_VOLATILE_STRIDE( 16, rs ) )
        {
 ...
 * -twiddle-log3 -precompute-twiddles -n 8 -dif -name hb2_8 -include rdft/scalar/hb.h */
