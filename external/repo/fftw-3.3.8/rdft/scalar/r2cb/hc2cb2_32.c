 ...
 * -sign 1 -twiddle-log3 -precompute-twiddles -n 32 -dif -name hc2cb2_32 -include
 * rdft/scalar/hc2cb.h */
...
static void hc2cb2_32( R* Rp, R* Ip, R* Rm, R* Im, const R* W, stride rs, INT mb, INT me, INT ms )
{
    ...
    {
        INT m;
        for ( m = mb, W = W + ( ( mb - 1 ) * 8 ); m < me; m = m + 1, Rp = Rp + ms, Ip = Ip + ms,
              Rm = Rm - ms, Im = Im - ms, W = W + 8, MAKE_VOLATILE_STRIDE( 128, rs ) )
        {
...
static const tw_instr twinstr[] = {
    {TW_CEXP, 1, 1}, {TW_CEXP, 1, 3}, {TW_CEXP, 1, 9}, {TW_CEXP, 1, 27}, {TW_NEXT, 1, 0}};
 ...
 * -twiddle-log3 -precompute-twiddles -n 32 -dif -name hc2cb2_32 -include rdft/scalar/hc2cb.h */
