...
/* Generated by: ../../../genfft/gen_hc2c.native -fma -compact -variables 4 -pipeline-latency 4
 * -sign 1 -twiddle-log3 -precompute-twiddles -n 4 -dif -name hc2cb2_4 -include rdft/scalar/hc2cb.h
 */
...
static void hc2cb2_4( R* Rp, R* Ip, R* Rm, R* Im, const R* W, stride rs, INT mb, INT me, INT ms )
{
    {
        INT m;
        for ( m = mb, W = W + ( ( mb - 1 ) * 4 ); m < me; m = m + 1, Rp = Rp + ms, Ip = Ip + ms,
              Rm = Rm - ms, Im = Im - ms, W = W + 4, MAKE_VOLATILE_STRIDE( 16, rs ) )
        {
...
static const tw_instr twinstr[] = {{TW_CEXP, 1, 1}, {TW_CEXP, 1, 3}, {TW_NEXT, 1, 0}};
...
/* Generated by: ../../../genfft/gen_hc2c.native -compact -variables 4 -pipeline-latency 4 -sign 1
 * -twiddle-log3 -precompute-twiddles -n 4 -dif -name hc2cb2_4 -include rdft/scalar/hc2cb.h */
