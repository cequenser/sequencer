 ...
 * -sign 1 -twiddle-log3 -precompute-twiddles -n 8 -dif -name hc2cb2_8 -include rdft/scalar/hc2cb.h
 */
...
static void hc2cb2_8( R* Rp, R* Ip, R* Rm, R* Im, const R* W, stride rs, INT mb, INT me, INT ms )
{
    ...
    {
        INT m;
        for ( m = mb, W = W + ( ( mb - 1 ) * 6 ); m < me; m = m + 1, Rp = Rp + ms, Ip = Ip + ms,
              Rm = Rm - ms, Im = Im - ms, W = W + 6, MAKE_VOLATILE_STRIDE( 32, rs ) )
        {
 ...
 * -twiddle-log3 -precompute-twiddles -n 8 -dif -name hc2cb2_8 -include rdft/scalar/hc2cb.h */
