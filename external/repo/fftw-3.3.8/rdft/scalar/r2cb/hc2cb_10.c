 ...
 * -sign 1 -n 10 -dif -name hc2cb_10 -include rdft/scalar/hc2cb.h */
...
static void hc2cb_10( R* Rp, R* Ip, R* Rm, R* Im, const R* W, stride rs, INT mb, INT me, INT ms )
{
    ...
    {
        INT m;
        for ( m = mb, W = W + ( ( mb - 1 ) * 18 ); m < me; m = m + 1, Rp = Rp + ms, Ip = Ip + ms,
              Rm = Rm - ms, Im = Im - ms, W = W + 18, MAKE_VOLATILE_STRIDE( 40, rs ) )
        {
 ...
 * -n 10 -dif -name hc2cb_10 -include rdft/scalar/hc2cb.h */
