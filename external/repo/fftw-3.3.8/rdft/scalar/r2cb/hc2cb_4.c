 ...
 * -sign 1 -n 4 -dif -name hc2cb_4 -include rdft/scalar/hc2cb.h */
...
{
    {
        ...
        for ( m = mb, W = W + ( ( mb - 1 ) * 6 ); m < me; m = m + 1, Rp = Rp + ms, Ip = Ip + ms,
              Rm = Rm - ms, Im = Im - ms, W = W + 6, MAKE_VOLATILE_STRIDE( 16, rs ) )
        {
 ...
 * -n 4 -dif -name hc2cb_4 -include rdft/scalar/hc2cb.h */
