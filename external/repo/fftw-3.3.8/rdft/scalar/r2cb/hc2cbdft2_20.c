 ...
 * -sign 1 -n 20 -dif -name hc2cbdft2_20 -include rdft/scalar/hc2cb.h */
...
static void hc2cbdft2_20( R* Rp, R* Ip, R* Rm, R* Im, const R* W, stride rs, INT mb, INT me,
                          INT ms )
{
    ...
    {
        INT m;
        for ( m = mb, W = W + ( ( mb - 1 ) * 38 ); m < me; m = m + 1, Rp = Rp + ms, Ip = Ip + ms,
              Rm = Rm - ms, Im = Im - ms, W = W + 38, MAKE_VOLATILE_STRIDE( 80, rs ) )
        {
 ...
 * 1 -n 20 -dif -name hc2cbdft2_20 -include rdft/scalar/hc2cb.h */
