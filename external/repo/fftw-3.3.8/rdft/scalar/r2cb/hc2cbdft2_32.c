 ...
 * -sign 1 -n 32 -dif -name hc2cbdft2_32 -include rdft/scalar/hc2cb.h */
...
static void hc2cbdft2_32( R* Rp, R* Ip, R* Rm, R* Im, const R* W, stride rs, INT mb, INT me,
                          INT ms )
{
    ...
    {
        INT m;
        for ( m = mb, W = W + ( ( mb - 1 ) * 62 ); m < me; m = m + 1, Rp = Rp + ms, Ip = Ip + ms,
              Rm = Rm - ms, Im = Im - ms, W = W + 62, MAKE_VOLATILE_STRIDE( 128, rs ) )
        {
...
/* Generated by: ../../../genfft/gen_hc2cdft.native -compact -variables 4 -pipeline-latency 4 -sign
 * 1 -n 32 -dif -name hc2cbdft2_32 -include rdft/scalar/hc2cb.h */
