 ...
 * -sign 1 -n 16 -name r2cbIII_16 -dft-III -include rdft/scalar/r2cbIII.h */
...
static void r2cbIII_16( R* R0, R* R1, R* Cr, R* Ci, stride rs, stride csr, stride csi, INT v,
                        INT ivs, INT ovs )
{
    ...
    DK( KP2_000000000, +2.000000000000000000000000000000000000000000000 );
    {
        ...
        for ( i = v; i > 0; i = i - 1, R0 = R0 + ovs, R1 = R1 + ovs, Cr = Cr + ivs, Ci = Ci + ivs,
              MAKE_VOLATILE_STRIDE( 64, rs ), MAKE_VOLATILE_STRIDE( 64, csr ),
              MAKE_VOLATILE_STRIDE( 64, csi ) )
        {
 ...
 * -n 16 -name r2cbIII_16 -dft-III -include rdft/scalar/r2cbIII.h */
