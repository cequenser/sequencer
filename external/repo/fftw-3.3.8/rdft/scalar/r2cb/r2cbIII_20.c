 ...
 * -sign 1 -n 20 -name r2cbIII_20 -dft-III -include rdft/scalar/r2cbIII.h */
...
static void r2cbIII_20( R* R0, R* R1, R* Cr, R* Ci, stride rs, stride csr, stride csi, INT v,
                        INT ivs, INT ovs )
{
    ...
    DK( KP618033988, +0.618033988749894848204586834365638117720309180 );
    {
        ...
        for ( i = v; i > 0; i = i - 1, R0 = R0 + ovs, R1 = R1 + ovs, Cr = Cr + ivs, Ci = Ci + ivs,
              MAKE_VOLATILE_STRIDE( 80, rs ), MAKE_VOLATILE_STRIDE( 80, csr ),
              MAKE_VOLATILE_STRIDE( 80, csi ) )
        {
 ...
 * -n 20 -name r2cbIII_20 -dft-III -include rdft/scalar/r2cbIII.h */
