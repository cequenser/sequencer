 ...
 * -sign 1 -n 32 -name r2cbIII_32 -dft-III -include rdft/scalar/r2cbIII.h */
...
static void r2cbIII_32( R* R0, R* R1, R* Cr, R* Ci, stride rs, stride csr, stride csi, INT v,
                        INT ivs, INT ovs )
{
    ...
    DK( KP414213562, +0.414213562373095048801688724209698078569671875 );
    {
        ...
        for ( i = v; i > 0; i = i - 1, R0 = R0 + ovs, R1 = R1 + ovs, Cr = Cr + ivs, Ci = Ci + ivs,
              MAKE_VOLATILE_STRIDE( 128, rs ), MAKE_VOLATILE_STRIDE( 128, csr ),
              MAKE_VOLATILE_STRIDE( 128, csi ) )
        {
 ...
 * -n 32 -name r2cbIII_32 -dft-III -include rdft/scalar/r2cbIII.h */
