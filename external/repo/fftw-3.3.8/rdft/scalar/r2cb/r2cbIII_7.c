 ...
 * -sign 1 -n 7 -name r2cbIII_7 -dft-III -include rdft/scalar/r2cbIII.h */
...
static void r2cbIII_7( R* R0, R* R1, R* Cr, R* Ci, stride rs, stride csr, stride csi, INT v,
                       INT ivs, INT ovs )
{
    ...
    DK( KP554958132, +0.554958132087371191422194871006410481067288862 );
    {
        ...
        for ( i = v; i > 0; i = i - 1, R0 = R0 + ovs, R1 = R1 + ovs, Cr = Cr + ivs, Ci = Ci + ivs,
              MAKE_VOLATILE_STRIDE( 28, rs ), MAKE_VOLATILE_STRIDE( 28, csr ),
              MAKE_VOLATILE_STRIDE( 28, csi ) )
        {
 ...
 * -n 7 -name r2cbIII_7 -dft-III -include rdft/scalar/r2cbIII.h */
