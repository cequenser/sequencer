 ...
 * -sign 1 -n 9 -name r2cbIII_9 -dft-III -include rdft/scalar/r2cbIII.h */
...
static void r2cbIII_9( R* R0, R* R1, R* Cr, R* Ci, stride rs, stride csr, stride csi, INT v,
                       INT ivs, INT ovs )
{
 ...
 * -n 9 -name r2cbIII_9 -dft-III -include rdft/scalar/r2cbIII.h */
