...
/* Generated by: ../../../genfft/gen_r2cb.native -fma -compact -variables 4 -pipeline-latency 4
 * -sign 1 -n 11 -name r2cb_11 -include rdft/scalar/r2cb.h */
...
static void r2cb_11( R* R0, R* R1, R* Cr, R* Ci, stride rs, stride csr, stride csi, INT v, INT ivs,
                     INT ovs )
{
    ...
    DK( KP521108558, +0.521108558113202722944698153526659300680427422 );
    {
        ...
        for ( i = v; i > 0; i = i - 1, R0 = R0 + ovs, R1 = R1 + ovs, Cr = Cr + ivs, Ci = Ci + ivs,
              MAKE_VOLATILE_STRIDE( 44, rs ), MAKE_VOLATILE_STRIDE( 44, csr ),
              MAKE_VOLATILE_STRIDE( 44, csi ) )
        {
...
/* Generated by: ../../../genfft/gen_r2cb.native -compact -variables 4 -pipeline-latency 4 -sign 1
 * -n 11 -name r2cb_11 -include rdft/scalar/r2cb.h */
                     ...
                     INT ovs )
{
    ...
    DK( KP1_081281634, +1.081281634911195164215271908637383390863541216 );
    {
              ...
              MAKE_VOLATILE_STRIDE( 44, csi ) )
        {
            ...
            T4 = Cr[ WS( csr, 3 ) ];
            T3 = Cr[ WS( csr, 2 ) ];
            T7 = FMA( KP1_682507065, T3, T1 ) + FNMS( KP284629676, T6, KP830830026 * T5 ) +
                 FNMA( KP1_309721467, T4, KP1_918985947 * T2 );
            Tk = FMA( KP1_682507065, T4, T1 ) + FNMS( KP1_918985947, T5, KP830830026 * T6 ) +
                 FNMA( KP284629676, T3, KP1_309721467 * T2 );
            Te = FMA( KP830830026, T4, T1 ) + FNMS( KP1_309721467, T6, KP1_682507065 * T5 ) +
                 FNMA( KP1_918985947, T3, KP284629676 * T2 );
            Tg = FMA( KP1_682507065, T2, T1 ) + FNMS( KP1_918985947, T6, KP830830026 * T3 ) +
                 FNMA( KP1_309721467, T5, KP284629676 * T4 );
            Ti = FMA( KP830830026, T2, T1 ) + FNMS( KP284629676, T5, KP1_682507065 * T6 ) +
