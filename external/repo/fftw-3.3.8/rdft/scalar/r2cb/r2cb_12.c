 ...
 * -sign 1 -n 12 -name r2cb_12 -include rdft/scalar/r2cb.h */
...
static void r2cb_12( R* R0, R* R1, R* Cr, R* Ci, stride rs, stride csr, stride csi, INT v, INT ivs,
                     INT ovs )
{
 ...
 * -n 12 -name r2cb_12 -include rdft/scalar/r2cb.h */
