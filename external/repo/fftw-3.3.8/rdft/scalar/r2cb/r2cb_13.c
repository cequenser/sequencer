 ...
 * -sign 1 -n 13 -name r2cb_13 -include rdft/scalar/r2cb.h */
...
static void r2cb_13( R* R0, R* R1, R* Cr, R* Ci, stride rs, stride csr, stride csi, INT v, INT ivs,
                     INT ovs )
{
    ...
    DK( KP500000000, +0.500000000000000000000000000000000000000000000 );
    {
        ...
        for ( i = v; i > 0; i = i - 1, R0 = R0 + ovs, R1 = R1 + ovs, Cr = Cr + ivs, Ci = Ci + ivs,
              MAKE_VOLATILE_STRIDE( 52, rs ), MAKE_VOLATILE_STRIDE( 52, csr ),
              MAKE_VOLATILE_STRIDE( 52, csi ) )
        {
 ...
 * -n 13 -name r2cb_13 -include rdft/scalar/r2cb.h */
