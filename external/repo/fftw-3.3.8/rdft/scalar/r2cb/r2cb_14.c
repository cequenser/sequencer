 ...
 * -sign 1 -n 14 -name r2cb_14 -include rdft/scalar/r2cb.h */
...
static void r2cb_14( R* R0, R* R1, R* Cr, R* Ci, stride rs, stride csr, stride csi, INT v, INT ivs,
                     INT ovs )
{
    ...
    DK( KP554958132, +0.554958132087371191422194871006410481067288862 );
    {
        ...
        for ( i = v; i > 0; i = i - 1, R0 = R0 + ovs, R1 = R1 + ovs, Cr = Cr + ivs, Ci = Ci + ivs,
              MAKE_VOLATILE_STRIDE( 56, rs ), MAKE_VOLATILE_STRIDE( 56, csr ),
              MAKE_VOLATILE_STRIDE( 56, csi ) )
        {
 ...
 * -n 14 -name r2cb_14 -include rdft/scalar/r2cb.h */
