 ...
 * -sign 1 -n 16 -name r2cb_16 -include rdft/scalar/r2cb.h */
...
static void r2cb_16( R* R0, R* R1, R* Cr, R* Ci, stride rs, stride csr, stride csi, INT v, INT ivs,
                     INT ovs )
{
 ...
 * -n 16 -name r2cb_16 -include rdft/scalar/r2cb.h */
