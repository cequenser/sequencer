 ...
 * -sign 1 -n 6 -name r2cb_6 -include rdft/scalar/r2cb.h */
...
static void r2cb_6( R* R0, R* R1, R* Cr, R* Ci, stride rs, stride csr, stride csi, INT v, INT ivs,
                    INT ovs )
{
 ...
 * -n 6 -name r2cb_6 -include rdft/scalar/r2cb.h */
