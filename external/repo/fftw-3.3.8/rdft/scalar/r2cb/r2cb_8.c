 ...
 * -sign 1 -n 8 -name r2cb_8 -include rdft/scalar/r2cb.h */
...
static void r2cb_8( R* R0, R* R1, R* Cr, R* Ci, stride rs, stride csr, stride csi, INT v, INT ivs,
                    INT ovs )
{
 ...
 * -n 8 -name r2cb_8 -include rdft/scalar/r2cb.h */
