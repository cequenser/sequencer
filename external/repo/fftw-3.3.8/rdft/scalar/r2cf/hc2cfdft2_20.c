 ...
 * -twiddle-log3 -precompute-twiddles -n 20 -dit -name hc2cfdft2_20 -include rdft/scalar/hc2cf.h */
...
static void hc2cfdft2_20( R* Rp, R* Ip, R* Rm, R* Im, const R* W, stride rs, INT mb, INT me,
                          INT ms )
{
