 ...
 * 12 -dit -name hf_12 -include rdft/scalar/hf.h */
...
static void hf_12( R* cr, R* ci, const R* W, stride rs, INT mb, INT me, INT ms )
{
    ...
    DK( KP500000000, +0.500000000000000000000000000000000000000000000 );
    {
        ...
        for ( m = mb, W = W + ( ( mb - 1 ) * 22 ); m < me;
              m = m + 1, cr = cr + ms, ci = ci - ms, W = W + 22, MAKE_VOLATILE_STRIDE( 24, rs ) )
        {
...
/* Generated by: ../../../genfft/gen_hc2hc.native -compact -variables 4 -pipeline-latency 4 -n 12
 * -dit -name hf_12 -include rdft/scalar/hf.h */
