 ...
 * 16 -dit -name hf_16 -include rdft/scalar/hf.h */
...
static void hf_16( R* cr, R* ci, const R* W, stride rs, INT mb, INT me, INT ms )
{
    ...
    {
        INT m;
        for ( m = mb, W = W + ( ( mb - 1 ) * 30 ); m < me;
              m = m + 1, cr = cr + ms, ci = ci - ms, W = W + 30, MAKE_VOLATILE_STRIDE( 32, rs ) )
        {
...
/* Generated by: ../../../genfft/gen_hc2hc.native -compact -variables 4 -pipeline-latency 4 -n 16
 * -dit -name hf_16 -include rdft/scalar/hf.h */
