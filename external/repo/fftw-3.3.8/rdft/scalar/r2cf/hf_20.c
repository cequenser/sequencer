 ...
 * 20 -dit -name hf_20 -include rdft/scalar/hf.h */
...
static void hf_20( R* cr, R* ci, const R* W, stride rs, INT mb, INT me, INT ms )
{
    ...
    DK( KP618033988, +0.618033988749894848204586834365638117720309180 );
    {
        ...
        for ( m = mb, W = W + ( ( mb - 1 ) * 38 ); m < me;
              m = m + 1, cr = cr + ms, ci = ci - ms, W = W + 38, MAKE_VOLATILE_STRIDE( 40, rs ) )
        {
...
/* Generated by: ../../../genfft/gen_hc2hc.native -compact -variables 4 -pipeline-latency 4 -n 20
 * -dit -name hf_20 -include rdft/scalar/hf.h */
