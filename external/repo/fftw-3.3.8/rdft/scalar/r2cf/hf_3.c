 ...
 * 3 -dit -name hf_3 -include rdft/scalar/hf.h */
...
static void hf_3( R* cr, R* ci, const R* W, stride rs, INT mb, INT me, INT ms )
{
    ...
    DK( KP500000000, +0.500000000000000000000000000000000000000000000 );
    {
        ...
        for ( m = mb, W = W + ( ( mb - 1 ) * 4 ); m < me;
              m = m + 1, cr = cr + ms, ci = ci - ms, W = W + 4, MAKE_VOLATILE_STRIDE( 6, rs ) )
        {
            E T1, Tl, T7, Th, Td, Tj;
            T1 = cr[ 0 ];
            Tl = ci[ 0 ];
...
/* Generated by: ../../../genfft/gen_hc2hc.native -compact -variables 4 -pipeline-latency 4 -n 3
 * -dit -name hf_3 -include rdft/scalar/hf.h */
