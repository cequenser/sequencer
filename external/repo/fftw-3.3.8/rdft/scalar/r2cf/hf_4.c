 ...
 * 4 -dit -name hf_4 -include rdft/scalar/hf.h */
...
{
    {
        ...
        for ( m = mb, W = W + ( ( mb - 1 ) * 6 ); m < me;
              m = m + 1, cr = cr + ms, ci = ci - ms, W = W + 6, MAKE_VOLATILE_STRIDE( 8, rs ) )
        {
...
/* Generated by: ../../../genfft/gen_hc2hc.native -compact -variables 4 -pipeline-latency 4 -n 4
 * -dit -name hf_4 -include rdft/scalar/hf.h */
