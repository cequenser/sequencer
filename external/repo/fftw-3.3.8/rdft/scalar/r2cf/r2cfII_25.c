 ...
 * 25 -name r2cfII_25 -dft-II -include rdft/scalar/r2cfII.h */
...
static void r2cfII_25( R* R0, R* R1, R* Cr, R* Ci, stride rs, stride csr, stride csi, INT v,
                       INT ivs, INT ovs )
{
 ...
 * -name r2cfII_25 -dft-II -include rdft/scalar/r2cfII.h */
