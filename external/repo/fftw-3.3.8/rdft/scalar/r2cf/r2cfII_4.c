...
/* Generated by: ../../../genfft/gen_r2cf.native -fma -compact -variables 4 -pipeline-latency 4 -n 4
 * -name r2cfII_4 -dft-II -include rdft/scalar/r2cfII.h */
...
static void r2cfII_4( R* R0, R* R1, R* Cr, R* Ci, stride rs, stride csr, stride csi, INT v, INT ivs,
                      INT ovs )
{
...
/* Generated by: ../../../genfft/gen_r2cf.native -compact -variables 4 -pipeline-latency 4 -n 4
 * -name r2cfII_4 -dft-II -include rdft/scalar/r2cfII.h */
