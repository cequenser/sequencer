...
/* Generated by: ../../../genfft/gen_r2cf.native -fma -compact -variables 4 -pipeline-latency 4 -n
 * 11 -name r2cf_11 -include rdft/scalar/r2cf.h */
...
static void r2cf_11( R* R0, R* R1, R* Cr, R* Ci, stride rs, stride csr, stride csi, INT v, INT ivs,
                     INT ovs )
{
...
/* Generated by: ../../../genfft/gen_r2cf.native -compact -variables 4 -pipeline-latency 4 -n 11
 * -name r2cf_11 -include rdft/scalar/r2cf.h */
    ...
    DK( KP755749574, +0.755749574354258283774035843972344420179717445 );
    {
              ...
              MAKE_VOLATILE_STRIDE( 44, csi ) )
        {
            ...
            Ci[ WS( csi, 4 ) ] = FMA( KP755749574, Th, KP540640817 * Ti ) +
                                 FNMS( KP909631995, Tk, KP281732556 * Tj ) - ( KP989821441 * Tl );
            ...
            Ci[ WS( csi, 2 ) ] = FMA( KP909631995, Th, KP755749574 * Tl ) +
                                 FNMA( KP540640817, Tk, KP989821441 * Tj ) - ( KP281732556 * Ti );
            Ci[ WS( csi, 5 ) ] = FMA( KP281732556, Th, KP755749574 * Ti ) +
                                 FNMS( KP909631995, Tj, KP989821441 * Tk ) - ( KP540640817 * Tl );
            Ci[ WS( csi, 1 ) ] = FMA( KP540640817, Th, KP909631995 * Tl ) +
                                 FMA( KP989821441, Ti, KP755749574 * Tj ) + ( KP281732556 * Tk );
            Ci[ WS( csi, 3 ) ] = FMA( KP989821441, Th, KP540640817 * Tj ) +
                                 FNMS( KP909631995, Ti, KP755749574 * Tk ) - ( KP281732556 * Tl );
