 ...
 * 13 -name r2cf_13 -include rdft/scalar/r2cf.h */
...
static void r2cf_13( R* R0, R* R1, R* Cr, R* Ci, stride rs, stride csr, stride csi, INT v, INT ivs,
                     INT ovs )
{
...
/* Generated by: ../../../genfft/gen_r2cf.native -compact -variables 4 -pipeline-latency 4 -n 13
 * -name r2cf_13 -include rdft/scalar/r2cf.h */
