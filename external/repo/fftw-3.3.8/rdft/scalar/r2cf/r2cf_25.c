 ...
 * 25 -name r2cf_25 -include rdft/scalar/r2cf.h */
...
static void r2cf_25( R* R0, R* R1, R* Cr, R* Ci, stride rs, stride csr, stride csi, INT v, INT ivs,
                     INT ovs )
{
    ...
    DK( KP618033988, +0.618033988749894848204586834365638117720309180 );
    {
        ...
        for ( i = v; i > 0; i = i - 1, R0 = R0 + ivs, R1 = R1 + ivs, Cr = Cr + ovs, Ci = Ci + ovs,
              MAKE_VOLATILE_STRIDE( 100, rs ), MAKE_VOLATILE_STRIDE( 100, csr ),
              MAKE_VOLATILE_STRIDE( 100, csi ) )
        {
...
/* Generated by: ../../../genfft/gen_r2cf.native -compact -variables 4 -pipeline-latency 4 -n 25
 * -name r2cf_25 -include rdft/scalar/r2cf.h */
              ...
              MAKE_VOLATILE_STRIDE( 100, csi ) )
        {
            ...
            }
            {
                ...
                Ci[ WS( csi, 9 ) ] = FMA( KP309016994, T1D, T1l ) +
                                     ...
                                     ( KP951056516 * ( Tq + TF ) );
                Cr[ WS( csr, 9 ) ] = FMA( KP309016994, TG, Tb ) +
            ...
            }
            {
                ...
                Ci[ WS( csi, 8 ) ] = FNMS( KP587785252, T21 + T22, KP309016994 * T1N ) +
                                     FNMA( KP809016994, T1U, KP951056516 * ( T1Y + T1Z ) ) - T1W;
                {
                    E T2e, T2f, T2n, T2p;
