 ...
 * 64 -name r2cf_64 -include rdft/scalar/r2cf.h */
...
static void r2cf_64( R* R0, R* R1, R* Cr, R* Ci, stride rs, stride csr, stride csi, INT v, INT ivs,
                     INT ovs )
{
 ...
 * -name r2cf_64 -include rdft/scalar/r2cf.h */
