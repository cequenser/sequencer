 ...
 * -pipeline-latency 8 -trivial-stores -variables 32 -no-generate-bytw -n 16 -dif -sign 1 -name
 * hc2cbdftv_16 -include rdft/simd/hc2cbv.h */
...
static void hc2cbdftv_16( R* Rp, R* Ip, R* Rm, R* Im, const R* W, stride rs, INT mb, INT me,
                          INT ms )
{
    ...
    DVK( KP707106781, +0.707106781186547524400844362104849039284835938 );
    {
        ...
        for ( m = mb, W = W + ( ( mb - 1 ) * ( ( TWVL / VL ) * 30 ) ); m < me; m = m + VL,
              ...
              Im = Im - ( VL * ms ), W = W + ( TWVL * 30 ), MAKE_VOLATILE_STRIDE( 64, rs ) )
        {
 ...
 * 8 -trivial-stores -variables 32 -no-generate-bytw -n 16 -dif -sign 1 -name hc2cbdftv_16 -include
 * rdft/simd/hc2cbv.h */
