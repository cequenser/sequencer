 ...
 * -pipeline-latency 8 -trivial-stores -variables 32 -no-generate-bytw -n 20 -dif -sign 1 -name
 * hc2cbdftv_20 -include rdft/simd/hc2cbv.h */
...
static void hc2cbdftv_20( R* Rp, R* Ip, R* Rm, R* Im, const R* W, stride rs, INT mb, INT me,
                          INT ms )
{
 ...
 * 8 -trivial-stores -variables 32 -no-generate-bytw -n 20 -dif -sign 1 -name hc2cbdftv_20 -include
 * rdft/simd/hc2cbv.h */
