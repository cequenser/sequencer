 ...
 * -pipeline-latency 8 -trivial-stores -variables 32 -no-generate-bytw -n 32 -dif -sign 1 -name
 * hc2cbdftv_32 -include rdft/simd/hc2cbv.h */
...
static void hc2cbdftv_32( R* Rp, R* Ip, R* Rm, R* Im, const R* W, stride rs, INT mb, INT me,
                          INT ms )
{
    ...
    DVK( KP414213562, +0.414213562373095048801688724209698078569671875 );
    {
        ...
        for ( m = mb, W = W + ( ( mb - 1 ) * ( ( TWVL / VL ) * 62 ) ); m < me; m = m + VL,
              ...
              Im = Im - ( VL * ms ), W = W + ( TWVL * 62 ), MAKE_VOLATILE_STRIDE( 128, rs ) )
        {
 ...
 * 8 -trivial-stores -variables 32 -no-generate-bytw -n 32 -dif -sign 1 -name hc2cbdftv_32 -include
 * rdft/simd/hc2cbv.h */
