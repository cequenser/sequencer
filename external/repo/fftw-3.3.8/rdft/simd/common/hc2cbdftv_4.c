 ...
 * -pipeline-latency 8 -trivial-stores -variables 32 -no-generate-bytw -n 4 -dif -sign 1 -name
 * hc2cbdftv_4 -include rdft/simd/hc2cbv.h */
...
static const tw_instr twinstr[] = {VTW( 1, 1 ), VTW( 1, 2 ), VTW( 1, 3 ), {TW_NEXT, VL, 0}};
 ...
 * 8 -trivial-stores -variables 32 -no-generate-bytw -n 4 -dif -sign 1 -name hc2cbdftv_4 -include
 * rdft/simd/hc2cbv.h */
