 ...
 * -pipeline-latency 8 -trivial-stores -variables 32 -no-generate-bytw -n 6 -dif -sign 1 -name
 * hc2cbdftv_6 -include rdft/simd/hc2cbv.h */
...
static void hc2cbdftv_6( R* Rp, R* Ip, R* Rm, R* Im, const R* W, stride rs, INT mb, INT me, INT ms )
{
    ...
    DVK( KP866025403, +0.866025403784438646763723170752936183471402627 );
    {
        ...
        for ( m = mb, W = W + ( ( mb - 1 ) * ( ( TWVL / VL ) * 10 ) ); m < me; m = m + VL,
              ...
              Im = Im - ( VL * ms ), W = W + ( TWVL * 10 ), MAKE_VOLATILE_STRIDE( 24, rs ) )
        {
 ...
 * 8 -trivial-stores -variables 32 -no-generate-bytw -n 6 -dif -sign 1 -name hc2cbdftv_6 -include
 * rdft/simd/hc2cbv.h */
