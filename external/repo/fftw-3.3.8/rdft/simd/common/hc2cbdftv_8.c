 ...
 * -pipeline-latency 8 -trivial-stores -variables 32 -no-generate-bytw -n 8 -dif -sign 1 -name
 * hc2cbdftv_8 -include rdft/simd/hc2cbv.h */
...
static void hc2cbdftv_8( R* Rp, R* Ip, R* Rm, R* Im, const R* W, stride rs, INT mb, INT me, INT ms )
{
    DVK( KP707106781, +0.707106781186547524400844362104849039284835938 );
    {
        ...
        for ( m = mb, W = W + ( ( mb - 1 ) * ( ( TWVL / VL ) * 14 ) ); m < me; m = m + VL,
              ...
              Im = Im - ( VL * ms ), W = W + ( TWVL * 14 ), MAKE_VOLATILE_STRIDE( 32, rs ) )
        {
...
static const tw_instr twinstr[] = {VTW( 1, 1 ), VTW( 1, 2 ), VTW( 1, 3 ), VTW( 1, 4 ),
                                   VTW( 1, 5 ), VTW( 1, 6 ), VTW( 1, 7 ), {TW_NEXT, VL, 0}};
 ...
 * 8 -trivial-stores -variables 32 -no-generate-bytw -n 8 -dif -sign 1 -name hc2cbdftv_8 -include
 * rdft/simd/hc2cbv.h */
