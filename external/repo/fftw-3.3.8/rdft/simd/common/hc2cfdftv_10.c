 ...
 * -pipeline-latency 8 -trivial-stores -variables 32 -no-generate-bytw -n 10 -dit -name hc2cfdftv_10
...
static void hc2cfdftv_10( R* Rp, R* Ip, R* Rm, R* Im, const R* W, stride rs, INT mb, INT me,
                          INT ms )
{
    ...
    DVK( KP500000000, +0.500000000000000000000000000000000000000000000 );
    {
        ...
        for ( m = mb, W = W + ( ( mb - 1 ) * ( ( TWVL / VL ) * 18 ) ); m < me; m = m + VL,
              ...
              Im = Im - ( VL * ms ), W = W + ( TWVL * 18 ), MAKE_VOLATILE_STRIDE( 40, rs ) )
        {
 ...
 * 8 -trivial-stores -variables 32 -no-generate-bytw -n 10 -dit -name hc2cfdftv_10 -include
 * rdft/simd/hc2cfv.h */
