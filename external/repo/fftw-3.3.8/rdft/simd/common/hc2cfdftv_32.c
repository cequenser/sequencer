 ...
 * -pipeline-latency 8 -trivial-stores -variables 32 -no-generate-bytw -n 32 -dit -name hc2cfdftv_32
...
static void hc2cfdftv_32( R* Rp, R* Ip, R* Rm, R* Im, const R* W, stride rs, INT mb, INT me,
                          INT ms )
{
 ...
 * 8 -trivial-stores -variables 32 -no-generate-bytw -n 32 -dit -name hc2cfdftv_32 -include
 * rdft/simd/hc2cfv.h */
