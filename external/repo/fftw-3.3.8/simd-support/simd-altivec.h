...
{
    const INT fovs = sizeof( R ) * ovs;
    const vector unsigned int even = VLIT( 0x00010203, 0x04050607, 0x10111213, 0x14151617 );
    const vector unsigned int odd = VLIT( 0x08090a0b, 0x0c0d0e0f, 0x18191a1b, 0x1c1d1e1f );
...
{
    const vector unsigned int perm = VLIT( 0x04050607, 0x00010203, 0x0c0d0e0f, 0x08090a0b );
...
{
    const vector unsigned int real = VLIT( 0x00010203, 0x00010203, 0x08090a0b, 0x08090a0b );
    const vector unsigned int imag = VLIT( 0x04050607, 0x04050607, 0x0c0d0e0f, 0x0c0d0e0f );
    V si = VBYI( sr );
...
#define VTW1( v, x )                                                                               \
    {TW_COS, v, x}, {TW_COS, v + 1, x}, {TW_SIN, v, x},                                            \
    {                                                                                              \
        TW_SIN, v + 1, x                                                                           \
    }
#define TWVL1 ( VL )
...
#define VTW2( v, x )                                                                               \
    {TW_COS, v, x}, {TW_COS, v, x}, {TW_COS, v + 1, x}, {TW_COS, v + 1, x}, {TW_SIN, v, -x},       \
        {TW_SIN, v, x}, {TW_SIN, v + 1, -x},                                                       \
    {                                                                                              \
        TW_SIN, v + 1, x                                                                           \
    }
#define TWVL2 ( 2 * VL )
...
#define VTWS( v, x )                                                                               \
    {TW_COS, v, x}, {TW_COS, v + 1, x}, {TW_COS, v + 2, x}, {TW_COS, v + 3, x}, {TW_SIN, v, x},    \
        {TW_SIN, v + 1, x}, {TW_SIN, v + 2, x},                                                    \
    {                                                                                              \
        TW_SIN, v + 3, x                                                                           \
    }
#define TWVLS ( 2 * VL )
