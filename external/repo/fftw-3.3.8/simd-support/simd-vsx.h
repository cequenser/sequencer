...
#define VDUPL( a )                                                                                 \
    ( {                                                                                            \
        const vector unsigned char perm = {0, 1, 2, 3, 0, 1, 2, 3, 8, 9, 10, 11, 8, 9, 10, 11};    \
        vec_perm( a, a, perm );                                                                    \
    } )
#define VDUPH( a )                                                                                 \
    ( {                                                                                            \
...
#define VDUPL( a )                                                                                 \
    ( {                                                                                            \
        const vector unsigned char perm = {0, 1, 2, 3, 4, 5, 6, 7, 0, 1, 2, 3, 4, 5, 6, 7};        \
        vec_perm( a, a, perm );                                                                    \
    } )
#define VDUPH( a )                                                                                 \
    ( {                                                                                            \
...
#else /* !FFTW_SINGLE */
#define VTW2( v, x )                                                                               \
    {TW_COS, v, x}, {TW_COS, v, x}, {TW_SIN, v, -x},                                               \
    {                                                                                              \
        TW_SIN, v, x                                                                               \
    }
#endif
