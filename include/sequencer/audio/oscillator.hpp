...
namespace sequencer::audio
{
    ...
    public:
        ...
        constexpr void set_wave_form( oscillator_wave_form wave_form )
        {
            wave_form_ = wave_form;
        }

        constexpr void set_frequency( double frequency ) noexcept
        {
            frequency_ = frequency;
        }

        constexpr void set_amplitude( double amplitude ) noexcept
        {
            amplitude_ = amplitude;
        }

        constexpr void set_phase( double phase ) noexcept
        {
            phase_ = phase;
        }

        constexpr void set_pulse_length( double pulse_length ) noexcept
        {
